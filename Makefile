...
ifeq ($(OS),Windows_NT)
SCRIPT := tools/poryscript/poryscript-windows/poryscript$(EXE) -s ROGUE_VERSION=ROGUE_VERSION_VANILLA
else
SCRIPT := tools/poryscript/poryscript-linux/poryscript$(EXE) -s ROGUE_VERSION=ROGUE_VERSION_VANILLA
endif
