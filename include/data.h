...
#define ITEM_CUSTOM_MOVES_ABILITY(party) { .ItemCustomMovesAbility = party }, .partySize = ARRAY_COUNT(party), .partyFlags = F_TRAINER_PARTY_CUSTOM_MOVESET | F_TRAINER_PARTY_ABILITY | F_TRAINER_PARTY_HELD_ITEM
