...
#define ITEM_BATTLE_CHECKER             (ITEM_ROGUE_ITEM_FIRST + 14)
...
#define TRAINER_FLAG_REGION_TEAM_ROCKET          (1 << 18) // Custom Team Rocket League; intentionally excluded from REGION_ANY
...
#define CONFIG_TOGGLE_TRAINER_TEAM_ROCKET     19
#endif
...
#define REVISION_FLAG_NONE          0
#define REVISION_FLAG_STATS         (1 << 0)
#define REVISION_FLAG_TYPING        (1 << 1)
#define REVISION_FLAG_ABILITY       (1 << 2)
#define REVISION_FLAG_LEARN_MOVES   (1 << 3)
#define REVISION_FLAG_TUTOR_MOVES   (1 << 4)
#define REVISION_FLAG_EVOLUTIONS    (1 << 5)
#define REVISION_FLAG_COMP_SETS     (1 << 6)
#define REVISION_FLAG_PROFILE_DATA  (REVISION_FLAG_STATS | REVISION_FLAG_TYPING | REVISION_FLAG_ABILITY)
#define REVISION_FLAG_ANY_MOVES     (REVISION_FLAG_TUTOR_MOVES | REVISION_FLAG_LEARN_MOVES)
#define REVISION_FLAG_BATTLE_ICON   (REVISION_FLAG_PROFILE_DATA)
#define REVISION_FLAG_POKEDEX_ICON  (REVISION_FLAG_PROFILE_DATA | REVISION_FLAG_TUTOR_MOVES | REVISION_FLAG_LEARN_MOVES)
#define REVISION_FLAG_ALL           (REVISION_FLAG_STATS | REVISION_FLAG_TYPING | REVISION_FLAG_ABILITY | REVISION_FLAG_LEARN_MOVES | REVISION_FLAG_TUTOR_MOVES | REVISION_FLAG_EVOLUTIONS | REVISION_FLAG_COMP_SETS)
