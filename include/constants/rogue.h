...
#define ITEM_ADAPTABILITY_CHARM         (FIRST_ITEM_CHARM + 12)

#define LAST_ITEM_CHARM                 (ITEM_ADAPTABILITY_CHARM)
...
#define ITEM_RANDOMAN_ROUTE_SPAWN_CURSE (FIRST_ITEM_CURSE + 19)
#define ITEM_RANDOMAN_ALWAYS_SPAWN_CURSE (FIRST_ITEM_CURSE + 20)

#define LAST_ITEM_CURSE                 (ITEM_RANDOMAN_ALWAYS_SPAWN_CURSE)
