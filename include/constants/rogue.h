...
#define DIFFICULTY_TOGGLE_BYTE_COUNT        (1 + DIFFICULTY_TOGGLE_COUNT / 8)
...
#define DIFFICULTY_RANGE_POKEDEX_VARIANT    4
#define DIFFICULTY_RANGE_POKEDEX_GEN        5
#define DIFFICULTY_RANGE_COUNT              6
