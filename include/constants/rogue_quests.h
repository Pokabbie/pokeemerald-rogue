...
#define QUEST_TRIGGER_FIELD_ITEM_USED       (1 << 17) // expect to condition against gSpecialVar_ItemId
#define QUEST_TRIGGER_BATTLE_ITEM_USED      (1 << 18) // expect to condition against gSpecialVar_ItemId
