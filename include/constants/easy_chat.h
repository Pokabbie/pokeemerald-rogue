...
#define EASY_CHAT_TYPE_ROGUE_SEED              9
#define EASY_CHAT_TYPE_GABBY_AND_TY            10
#define EASY_CHAT_TYPE_CONTEST_INTERVIEW       11
#define EASY_CHAT_TYPE_ROGUE_GAMESHOW_CHOOSE_MON 12
...
#define EASY_CHAT_TYPE_ROGUE_CAMPAIGN          21


#define EASY_CHAT_PERSON_REPORTER_MALE   0
#define EASY_CHAT_PERSON_REPORTER_FEMALE 1
#define EASY_CHAT_PERSON_BOY             2
#define EASY_CHAT_PERSON_RANDOMAN        3
#define EASY_CHAT_PERSON_DISPLAY_NONE    4
