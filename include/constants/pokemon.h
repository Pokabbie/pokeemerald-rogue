...
#define MON_DATA_HIDDEN_NATURE     10
...
#define MON_DATA_IS_SHINY          51 // Originally MON_DATA_COOL_RIBBON
#define MON_DATA_GENDER_FLAG       52 // MON_DATA_BEAUTY_RIBBON
...
#define MON_DATA_TUTOR_MOVE_LVL    90
