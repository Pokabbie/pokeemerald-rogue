...
#define MUS_DP_ROUTE201_DAY             (MUS_HG_ENCOUNTER_SUSPICIOUS_2 + 1)
#define MUS_DP_ROUTE203_DAY             (MUS_HG_ENCOUNTER_SUSPICIOUS_2 + 2)
#define MUS_DP_ROUTE205_DAY             (MUS_HG_ENCOUNTER_SUSPICIOUS_2 + 3)
#define MUS_DP_ROUTE206_DAY             (MUS_HG_ENCOUNTER_SUSPICIOUS_2 + 4)
#define MUS_DP_ROUTE209_DAY             (MUS_HG_ENCOUNTER_SUSPICIOUS_2 + 5)
#define MUS_DP_ROUTE210_DAY             (MUS_HG_ENCOUNTER_SUSPICIOUS_2 + 6)
#define MUS_DP_ROUTE216_DAY             (MUS_HG_ENCOUNTER_SUSPICIOUS_2 + 7)
#define MUS_DP_ROUTE228_DAY             (MUS_HG_ENCOUNTER_SUSPICIOUS_2 + 8)
#define MUS_DP_ETERNA_FOREST            (MUS_HG_ENCOUNTER_SUSPICIOUS_2 + 9)
#define MUS_DP_MT_CORONET               (MUS_HG_ENCOUNTER_SUSPICIOUS_2 + 10)
#define MUS_DP_SPEAR_PILLAR             (MUS_HG_ENCOUNTER_SUSPICIOUS_2 + 11)
#define MUS_DP_LAKE_CAVERNS             (MUS_HG_ENCOUNTER_SUSPICIOUS_2 + 12)
#define MUS_DP_TITLE                    (MUS_HG_ENCOUNTER_SUSPICIOUS_2 + 13)
