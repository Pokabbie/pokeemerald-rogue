...
#define MUS_HG_ENCOUNTER_RIVAL          (PH_NURSE_SOLO + 21)
#define MUS_HG_ENCOUNTER_GIRL_1         (PH_NURSE_SOLO + 22)
#define MUS_HG_ENCOUNTER_BOY_1          (PH_NURSE_SOLO + 23)
#define MUS_HG_ENCOUNTER_SUSPICIOUS_1   (PH_NURSE_SOLO + 24)
#define MUS_HG_ENCOUNTER_SAGE           (PH_NURSE_SOLO + 25)
#define MUS_HG_ENCOUNTER_KIMONO_GIRL    (PH_NURSE_SOLO + 26)
#define MUS_HG_ENCOUNTER_ROCKET         (PH_NURSE_SOLO + 27)
#define MUS_HG_ENCOUNTER_GIRL_2         (PH_NURSE_SOLO + 28)
#define MUS_HG_ENCOUNTER_BOY_2          (PH_NURSE_SOLO + 29)
#define MUS_HG_ENCOUNTER_SUSPICIOUS_2   (PH_NURSE_SOLO + 30)

#define MUS_DP_VS_WILD                  (MUS_HG_ENCOUNTER_SUSPICIOUS_2 + 1)
#define MUS_DP_VS_GYM_LEADER            (MUS_HG_ENCOUNTER_SUSPICIOUS_2 + 2)
#define MUS_DP_VS_UXIE_MESPRIT_AZELF    (MUS_HG_ENCOUNTER_SUSPICIOUS_2 + 3)
#define MUS_DP_VS_TRAINER               (MUS_HG_ENCOUNTER_SUSPICIOUS_2 + 4) 
#define MUS_DP_VS_GALACTIC_BOSS         (MUS_HG_ENCOUNTER_SUSPICIOUS_2 + 5)
#define MUS_DP_VS_DIALGA_PALKIA         (MUS_HG_ENCOUNTER_SUSPICIOUS_2 + 6) 
#define MUS_DP_VS_CHAMPION              (MUS_HG_ENCOUNTER_SUSPICIOUS_2 + 7) 
#define MUS_DP_VS_GALACTIC              (MUS_HG_ENCOUNTER_SUSPICIOUS_2 + 8) 
#define MUS_DP_VS_RIVAL                 (MUS_HG_ENCOUNTER_SUSPICIOUS_2 + 9) 
#define MUS_DP_VS_ARCEUS                (MUS_HG_ENCOUNTER_SUSPICIOUS_2 + 10) 
#define MUS_DP_VS_LEGEND                (MUS_HG_ENCOUNTER_SUSPICIOUS_2 + 11)
#define MUS_DP_VS_GALACTIC_COMMANDER    (MUS_HG_ENCOUNTER_SUSPICIOUS_2 + 12)
#define MUS_DP_VS_ELITE_FOUR            (MUS_HG_ENCOUNTER_SUSPICIOUS_2 + 13)
#define  MUS_DP_ENCOUNTER_BOY           (MUS_HG_ENCOUNTER_SUSPICIOUS_2 + 14)
#define  MUS_DP_ENCOUNTER_TWINS         (MUS_HG_ENCOUNTER_SUSPICIOUS_2 + 15)
#define  MUS_DP_ENCOUNTER_INTENSE       (MUS_HG_ENCOUNTER_SUSPICIOUS_2 + 16)
#define  MUS_DP_ENCOUNTER_GALACTIC      (MUS_HG_ENCOUNTER_SUSPICIOUS_2 + 17)
#define  MUS_DP_ENCOUNTER_LADY          (MUS_HG_ENCOUNTER_SUSPICIOUS_2 + 18)
#define  MUS_DP_ENCOUNTER_HIKER         (MUS_HG_ENCOUNTER_SUSPICIOUS_2 + 19)
#define  MUS_DP_ENCOUNTER_RICH          (MUS_HG_ENCOUNTER_SUSPICIOUS_2 + 20)
#define  MUS_DP_ENCOUNTER_SAILOR        (MUS_HG_ENCOUNTER_SUSPICIOUS_2 + 21)
#define  MUS_DP_ENCOUNTER_SUSPICIOUS    (MUS_HG_ENCOUNTER_SUSPICIOUS_2 + 22)
#define  MUS_DP_ENCOUNTER_ACE_TRAINER   (MUS_HG_ENCOUNTER_SUSPICIOUS_2 + 23)
#define  MUS_DP_ENCOUNTER_GIRL          (MUS_HG_ENCOUNTER_SUSPICIOUS_2 + 24)
#define  MUS_DP_ENCOUNTER_CYCLIST       (MUS_HG_ENCOUNTER_SUSPICIOUS_2 + 25)
#define  MUS_DP_ENCOUNTER_ARTIST        (MUS_HG_ENCOUNTER_SUSPICIOUS_2 + 26)
#define  MUS_DP_ENCOUNTER_ELITE_FOUR    (MUS_HG_ENCOUNTER_SUSPICIOUS_2 + 27)
#define  MUS_DP_ENCOUNTER_CHAMPION      (MUS_HG_ENCOUNTER_SUSPICIOUS_2 + 28)
#define  MUS_DP_VICTORY_WILD            (MUS_HG_ENCOUNTER_SUSPICIOUS_2 + 29)
#define  MUS_DP_VICTORY_TRAINER         (MUS_HG_ENCOUNTER_SUSPICIOUS_2 + 30)
#define  MUS_DP_VICTORY_GYM_LEADER      (MUS_HG_ENCOUNTER_SUSPICIOUS_2 + 31)
#define  MUS_DP_VICTORY_CHAMPION        (MUS_HG_ENCOUNTER_SUSPICIOUS_2 + 32)
#define  MUS_DP_VICTORY_GALACTIC        (MUS_HG_ENCOUNTER_SUSPICIOUS_2 + 33)
#define  MUS_DP_VICTORY_ELITE_FOUR      (MUS_HG_ENCOUNTER_SUSPICIOUS_2 + 34)

#define MUS_PL_VS_GIRATINA              (MUS_HG_ENCOUNTER_SUSPICIOUS_2 + 35)
