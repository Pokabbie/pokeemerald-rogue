...
#define MUS_HG_START                    PH_NURSE_SOLO

#define MUS_HG_VS_WILD                  (MUS_HG_START + 1)
#define MUS_HG_VS_TRAINER               (MUS_HG_START + 2)
#define MUS_HG_VS_TRAINER_KANTO         (MUS_HG_START + 3)
#define MUS_HG_VS_GYM_LEADER            (MUS_HG_START + 4)
#define MUS_HG_VS_GYM_LEADER_KANTO      (MUS_HG_START + 5)
#define MUS_HG_VS_CHAMPION              (MUS_HG_START + 6)
#define MUS_HG_VS_FRONTIER_BRAIN        (MUS_HG_START + 7)
#define MUS_HG_VICTORY_FRONTIER_BRAIN   (MUS_HG_START + 8)
#define MUS_HG_VICTORY_TRAINER          (MUS_HG_START + 9)
#define MUS_HG_VICTORY_GYM_LEADER       (MUS_HG_START + 10)
#define MUS_HG_VS_RIVAL                 (MUS_HG_START + 11)
#define MUS_HG_VS_ROCKET                (MUS_HG_START + 12)
#define MUS_HG_VS_SUICUNE               (MUS_HG_START + 13)
#define MUS_HG_VS_ENTEI                 (MUS_HG_START + 14)
#define MUS_HG_VS_RAIKOU                (MUS_HG_START + 15)
#define MUS_HG_VS_HO_OH                 (MUS_HG_START + 16)
#define MUS_HG_VS_LUGIA                 (MUS_HG_START + 17)
#define MUS_HG_ROUTE29                  (MUS_HG_START + 18)
#define MUS_HG_ROUTE30                  (MUS_HG_START + 19)
#define MUS_HG_ROUTE34                  (MUS_HG_START + 20)
#define MUS_HG_ROUTE38                  (MUS_HG_START + 21)
#define MUS_HG_ROUTE42                  (MUS_HG_START + 22)
#define MUS_HG_ROUTE47                  (MUS_HG_START + 23)
#define MUS_HG_ICE_PATH                 (MUS_HG_START + 24)
#define MUS_HG_ENCOUNTER_RIVAL          (MUS_HG_START + 25)
#define MUS_HG_ENCOUNTER_GIRL_1         (MUS_HG_START + 26)
#define MUS_HG_ENCOUNTER_BOY_1          (MUS_HG_START + 27)
#define MUS_HG_ENCOUNTER_SUSPICIOUS_1   (MUS_HG_START + 28)
#define MUS_HG_ENCOUNTER_SAGE           (MUS_HG_START + 29)
#define MUS_HG_ENCOUNTER_KIMONO_GIRL    (MUS_HG_START + 30)
#define MUS_HG_ENCOUNTER_ROCKET         (MUS_HG_START + 31)
#define MUS_HG_ENCOUNTER_GIRL_2         (MUS_HG_START + 32)
#define MUS_HG_ENCOUNTER_BOY_2          (MUS_HG_START + 33)
#define MUS_HG_ENCOUNTER_SUSPICIOUS_2   (MUS_HG_START + 34)
#define MUS_HG_TITLE                    (MUS_HG_START + 35)
#define MUS_HG_CREDITS                  (MUS_HG_START + 36)
#define MUS_HG_END                      (MUS_HG_START + 37)
#define MUS_HG_NEW_BARK                 (MUS_HG_START + 38)
#define MUS_HG_NATIONAL_PARK            (MUS_HG_START + 39)
#define MUS_HG_DANCE_THEATER            (MUS_HG_START + 40)
#define MUS_HG_GAME_CORNER              (MUS_HG_START + 41)
#define MUS_HG_GAME_CORNER_WIN          (MUS_HG_START + 42)
#define MUS_HG_TEAM_ROCKET_HQ           (MUS_HG_START + 43)
#define MUS_HG_BUG_CONTEST_PREP         (MUS_HG_START + 44)
#define MUS_HG_BUG_CATCHING_CONTEST     (MUS_HG_START + 45)
#define MUS_HG_BUG_CONTEST_1ST_PLACE    (MUS_HG_START + 46)
#define MUS_HG_BUG_CONTEST_2ND_PLACE    (MUS_HG_START + 47)
#define MUS_HG_BUG_CONTEST_3RD_PLACE    (MUS_HG_START + 48)
#define MUS_HG_ROCKET_TAKEOVER          (MUS_HG_START + 49)
#define MUS_HG_ELM_LAB                  (MUS_HG_START + 50)
#define MUS_HG_KIMONO_GIRL              (MUS_HG_START + 51)
#define MUS_HG_CARD_FLIP                (MUS_HG_START + 52)
#define MUS_HG_CARD_FLIP_GAME_OVER      (MUS_HG_START + 53)
#define MUS_HG_B_ARCADE                 (MUS_HG_START + 54)
#define MUS_HG_B_CASTLE                 (MUS_HG_START + 55)
#define MUS_HG_B_FACTORY                (MUS_HG_START + 56)
#define MUS_HG_B_HALL                   (MUS_HG_START + 57)
#define MUS_HG_B_TOWER                  (MUS_HG_START + 58)
#define MUS_HG_B_TOWER_RECEPTION        (MUS_HG_START + 59)
#define MUS_HG_EVOLUTION                (MUS_HG_START + 60)
#define MUS_HG_EVOLVED                  (MUS_HG_START + 61)
#define MUS_HG_GYM                      (MUS_HG_START + 62)
#define MUS_HG_LEVEL_UP                 (MUS_HG_START + 63)
#define MUS_HG_MAGNET_TRAIN             (MUS_HG_START + 64)
#define MUS_HG_SINJOU_RUINS             (MUS_HG_START + 65)
#define MUS_HG_VICTORY_WILD             (MUS_HG_START + 66)

#define MUS_DP_START                    MUS_HG_VICTORY_WILD

#define MUS_DP_ROUTE201_DAY             (MUS_DP_START + 1)
#define MUS_DP_ROUTE203_DAY             (MUS_DP_START + 2)
#define MUS_DP_ROUTE205_DAY             (MUS_DP_START + 3)
#define MUS_DP_ROUTE206_DAY             (MUS_DP_START + 4)
#define MUS_DP_ROUTE209_DAY             (MUS_DP_START + 5)
#define MUS_DP_ROUTE210_DAY             (MUS_DP_START + 6)
#define MUS_DP_ROUTE216_DAY             (MUS_DP_START + 7)
#define MUS_DP_ROUTE228_DAY             (MUS_DP_START + 8)
#define MUS_DP_ETERNA_FOREST            (MUS_DP_START + 9)
#define MUS_DP_MT_CORONET               (MUS_DP_START + 10)
#define MUS_DP_SPEAR_PILLAR             (MUS_DP_START + 11)
#define MUS_DP_LAKE_CAVERNS             (MUS_DP_START + 12)
#define MUS_DP_TITLE                    (MUS_DP_START + 13)
#define MUS_DP_VS_WILD                  (MUS_DP_START + 14)
#define MUS_DP_VS_GYM_LEADER            (MUS_DP_START + 15)
#define MUS_DP_VS_UXIE_MESPRIT_AZELF    (MUS_DP_START + 16)
#define MUS_DP_VS_TRAINER               (MUS_DP_START + 17) 
#define MUS_DP_VS_GALACTIC_BOSS         (MUS_DP_START + 18)
#define MUS_DP_VS_DIALGA_PALKIA         (MUS_DP_START + 19) 
#define MUS_DP_VS_CHAMPION              (MUS_DP_START + 20) 
#define MUS_DP_VS_GALACTIC              (MUS_DP_START + 21) 
#define MUS_DP_VS_RIVAL                 (MUS_DP_START + 22) 
#define MUS_DP_VS_ARCEUS                (MUS_DP_START + 23) 
#define MUS_DP_VS_LEGEND                (MUS_DP_START + 24)
#define MUS_DP_VS_GALACTIC_COMMANDER    (MUS_DP_START + 25)
#define MUS_DP_VS_ELITE_FOUR            (MUS_DP_START + 26)
#define MUS_DP_ENCOUNTER_BOY            (MUS_DP_START + 27)
#define MUS_DP_ENCOUNTER_TWINS          (MUS_DP_START + 28)
#define MUS_DP_ENCOUNTER_INTENSE        (MUS_DP_START + 29)
#define MUS_DP_ENCOUNTER_GALACTIC       (MUS_DP_START + 30)
#define MUS_DP_ENCOUNTER_LADY           (MUS_DP_START + 31)
#define MUS_DP_ENCOUNTER_HIKER          (MUS_DP_START + 32)
#define MUS_DP_ENCOUNTER_RICH           (MUS_DP_START + 33)
#define MUS_DP_ENCOUNTER_SAILOR         (MUS_DP_START + 34)
#define MUS_DP_ENCOUNTER_SUSPICIOUS     (MUS_DP_START + 35)
#define MUS_DP_ENCOUNTER_ACE_TRAINER    (MUS_DP_START + 36)
#define MUS_DP_ENCOUNTER_GIRL           (MUS_DP_START + 37)
#define MUS_DP_ENCOUNTER_CYCLIST        (MUS_DP_START + 38)
#define MUS_DP_ENCOUNTER_ARTIST         (MUS_DP_START + 39)
#define MUS_DP_ENCOUNTER_ELITE_FOUR     (MUS_DP_START + 40)
#define MUS_DP_ENCOUNTER_CHAMPION       (MUS_DP_START + 41)
#define MUS_DP_VICTORY_WILD             (MUS_DP_START + 42)
#define MUS_DP_VICTORY_TRAINER          (MUS_DP_START + 43)
#define MUS_DP_VICTORY_GYM_LEADER       (MUS_DP_START + 44)
#define MUS_DP_VICTORY_CHAMPION         (MUS_DP_START + 45)
#define MUS_DP_VICTORY_GALACTIC         (MUS_DP_START + 46)
#define MUS_DP_VICTORY_ELITE_FOUR       (MUS_DP_START + 47)
#define MUS_DP_HALL_OF_ORIGIN           (MUS_DP_START + 48)
#define MUS_DP_FLOAROMA_DAY             (MUS_DP_START + 49)
#define MUS_DP_HALL_OF_FAME             (MUS_DP_START + 50)
#define MUS_DP_HEAL                     (MUS_DP_START + 51)
#define MUS_DP_FIGHT_AREA_DAY           (MUS_DP_START + 52)
#define MUS_DP_INSIDE_POKEMON_LEAGUE    (MUS_DP_START + 53)
#define MUS_DP_SANDGEM_DAY              (MUS_DP_START + 54)
#define MUS_DP_SNOWPOINT_DAY            (MUS_DP_START + 55)
#define MUS_DP_SOLACEON_DAY             (MUS_DP_START + 56)
#define MUS_DP_UNDERGROUND              (MUS_DP_START + 57)
#define MUS_DP_GYM                      (MUS_DP_START + 58)
#define MUS_DP_EVOLUTION                (MUS_DP_START + 59)
#define MUS_DP_EVOLVED                  (MUS_DP_START + 60)
#define MUS_DP_GTS                      (MUS_DP_START + 61)
