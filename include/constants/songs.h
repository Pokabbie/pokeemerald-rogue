...
#define MUS_HG_VS_TRAINER_KANTO         (PH_NURSE_SOLO + 3)
#define MUS_HG_VS_GYM_LEADER            (PH_NURSE_SOLO + 4)
#define MUS_HG_VS_GYM_LEADER_KANTO      (PH_NURSE_SOLO + 5)
#define MUS_HG_VS_CHAMPION              (PH_NURSE_SOLO + 6)
#define MUS_HG_VS_FRONTIER_BRAIN        (PH_NURSE_SOLO + 7)
#define MUS_HG_VICTORY_FRONTIER_BRAIN   (PH_NURSE_SOLO + 8)
#define MUS_HG_VICTORY_TRAINER          (PH_NURSE_SOLO + 9)
#define MUS_HG_VICTORY_GYM_LEADER       (PH_NURSE_SOLO + 10)
#define MUS_HG_VS_RIVAL                 (PH_NURSE_SOLO + 11)
#define MUS_HG_VS_ROCKET                (PH_NURSE_SOLO + 12)
#define MUS_HG_VS_SUICUNE               (PH_NURSE_SOLO + 13)
#define MUS_HG_VS_ENTEI                 (PH_NURSE_SOLO + 14)
#define MUS_HG_VS_RAIKOU                (PH_NURSE_SOLO + 15)
#define MUS_HG_VS_HO_OH                 (PH_NURSE_SOLO + 16)
#define MUS_HG_VS_LUGIA                 (PH_NURSE_SOLO + 17)
#define MUS_HG_ROUTE29                  (PH_NURSE_SOLO + 18)
#define MUS_HG_ROUTE30                  (PH_NURSE_SOLO + 19)
#define MUS_HG_ROUTE34                  (PH_NURSE_SOLO + 20)
#define MUS_HG_ROUTE38                  (PH_NURSE_SOLO + 21)
#define MUS_HG_ROUTE42                  (PH_NURSE_SOLO + 22)
#define MUS_HG_ROUTE47                  (PH_NURSE_SOLO + 23)
#define MUS_HG_ICE_PATH                 (PH_NURSE_SOLO + 24)
#define MUS_HG_ENCOUNTER_RIVAL          (PH_NURSE_SOLO + 25)
#define MUS_HG_ENCOUNTER_GIRL_1         (PH_NURSE_SOLO + 26)
#define MUS_HG_ENCOUNTER_BOY_1          (PH_NURSE_SOLO + 27)
#define MUS_HG_ENCOUNTER_SUSPICIOUS_1   (PH_NURSE_SOLO + 28)
#define MUS_HG_ENCOUNTER_SAGE           (PH_NURSE_SOLO + 29)
#define MUS_HG_ENCOUNTER_KIMONO_GIRL    (PH_NURSE_SOLO + 30)
#define MUS_HG_ENCOUNTER_ROCKET         (PH_NURSE_SOLO + 31)
#define MUS_HG_ENCOUNTER_GIRL_2         (PH_NURSE_SOLO + 32)
#define MUS_HG_ENCOUNTER_BOY_2          (PH_NURSE_SOLO + 33)
#define MUS_HG_ENCOUNTER_SUSPICIOUS_2   (PH_NURSE_SOLO + 34)
#define MUS_HG_TITLE                    (PH_NURSE_SOLO + 35)
#define MUS_HG_CREDITS                  (PH_NURSE_SOLO + 36)
#define MUS_HG_END                      (PH_NURSE_SOLO + 37)
#define MUS_HG_NEW_BARK                 (PH_NURSE_SOLO + 38)
#define MUS_HG_NATIONAL_PARK            (PH_NURSE_SOLO + 39)
#define MUS_HG_DANCE_THEATER            (PH_NURSE_SOLO + 40)
#define MUS_HG_GAME_CORNER              (PH_NURSE_SOLO + 41)
#define MUS_HG_GAME_CORNER_WIN          (PH_NURSE_SOLO + 42)
#define MUS_HG_TEAM_ROCKET_HQ           (PH_NURSE_SOLO + 43)
#define MUS_HG_BUG_CONTEST_PREP         (PH_NURSE_SOLO + 44)
#define MUS_HG_BUG_CATCHING_CONTEST     (PH_NURSE_SOLO + 45)
#define MUS_HG_BUG_CONTEST_1ST_PLACE    (PH_NURSE_SOLO + 46)
#define MUS_HG_BUG_CONTEST_2ND_PLACE    (PH_NURSE_SOLO + 47)
#define MUS_HG_BUG_CONTEST_3RD_PLACE    (PH_NURSE_SOLO + 48)
#define MUS_HG_ROCKET_TAKEOVER          (PH_NURSE_SOLO + 49)
#define MUS_HG_ELM_LAB                  (PH_NURSE_SOLO + 50)
#define MUS_HG_KIMONO_GIRL              (PH_NURSE_SOLO + 51)
#define MUS_HG_CARD_FLIP                (PH_NURSE_SOLO + 52)
#define MUS_HG_CARD_FLIP_GAME_OVER      (PH_NURSE_SOLO + 53)

#define MUS_DP_ROUTE201_DAY             (MUS_HG_CARD_FLIP_GAME_OVER + 1)
#define MUS_DP_ROUTE203_DAY             (MUS_HG_CARD_FLIP_GAME_OVER + 2)
#define MUS_DP_ROUTE205_DAY             (MUS_HG_CARD_FLIP_GAME_OVER + 3)
#define MUS_DP_ROUTE206_DAY             (MUS_HG_CARD_FLIP_GAME_OVER + 4)
#define MUS_DP_ROUTE209_DAY             (MUS_HG_CARD_FLIP_GAME_OVER + 5)
#define MUS_DP_ROUTE210_DAY             (MUS_HG_CARD_FLIP_GAME_OVER + 6)
#define MUS_DP_ROUTE216_DAY             (MUS_HG_CARD_FLIP_GAME_OVER + 7)
#define MUS_DP_ROUTE228_DAY             (MUS_HG_CARD_FLIP_GAME_OVER + 8)
#define MUS_DP_ETERNA_FOREST            (MUS_HG_CARD_FLIP_GAME_OVER + 9)
#define MUS_DP_MT_CORONET               (MUS_HG_CARD_FLIP_GAME_OVER + 10)
#define MUS_DP_SPEAR_PILLAR             (MUS_HG_CARD_FLIP_GAME_OVER + 11)
#define MUS_DP_LAKE_CAVERNS             (MUS_HG_CARD_FLIP_GAME_OVER + 12)
#define MUS_DP_TITLE                    (MUS_HG_CARD_FLIP_GAME_OVER + 13)
#define MUS_DP_VS_WILD                  (MUS_DP_TITLE + 1)
#define MUS_DP_VS_GYM_LEADER            (MUS_DP_TITLE + 2)
#define MUS_DP_VS_UXIE_MESPRIT_AZELF    (MUS_DP_TITLE + 3)
#define MUS_DP_VS_TRAINER               (MUS_DP_TITLE + 4) 
#define MUS_DP_VS_GALACTIC_BOSS         (MUS_DP_TITLE + 5)
#define MUS_DP_VS_DIALGA_PALKIA         (MUS_DP_TITLE + 6) 
#define MUS_DP_VS_CHAMPION              (MUS_DP_TITLE + 7) 
#define MUS_DP_VS_GALACTIC              (MUS_DP_TITLE + 8) 
#define MUS_DP_VS_RIVAL                 (MUS_DP_TITLE + 9) 
#define MUS_DP_VS_ARCEUS                (MUS_DP_TITLE + 10) 
#define MUS_DP_VS_LEGEND                (MUS_DP_TITLE + 11)
#define MUS_DP_VS_GALACTIC_COMMANDER    (MUS_DP_TITLE + 12)
#define MUS_DP_VS_ELITE_FOUR            (MUS_DP_TITLE + 13)
#define MUS_DP_ENCOUNTER_BOY            (MUS_DP_TITLE + 14)
#define MUS_DP_ENCOUNTER_TWINS          (MUS_DP_TITLE + 15)
#define MUS_DP_ENCOUNTER_INTENSE        (MUS_DP_TITLE + 16)
#define MUS_DP_ENCOUNTER_GALACTIC       (MUS_DP_TITLE + 17)
#define MUS_DP_ENCOUNTER_LADY           (MUS_DP_TITLE + 18)
#define MUS_DP_ENCOUNTER_HIKER          (MUS_DP_TITLE + 19)
#define MUS_DP_ENCOUNTER_RICH           (MUS_DP_TITLE + 20)
#define MUS_DP_ENCOUNTER_SAILOR         (MUS_DP_TITLE + 21)
#define MUS_DP_ENCOUNTER_SUSPICIOUS     (MUS_DP_TITLE + 22)
#define MUS_DP_ENCOUNTER_ACE_TRAINER    (MUS_DP_TITLE + 23)
#define MUS_DP_ENCOUNTER_GIRL           (MUS_DP_TITLE + 24)
#define MUS_DP_ENCOUNTER_CYCLIST        (MUS_DP_TITLE + 25)
#define MUS_DP_ENCOUNTER_ARTIST         (MUS_DP_TITLE + 26)
#define MUS_DP_ENCOUNTER_ELITE_FOUR     (MUS_DP_TITLE + 27)
#define MUS_DP_ENCOUNTER_CHAMPION       (MUS_DP_TITLE + 28)
#define MUS_DP_VICTORY_WILD             (MUS_DP_TITLE + 29)
#define MUS_DP_VICTORY_TRAINER          (MUS_DP_TITLE + 30)
#define MUS_DP_VICTORY_GYM_LEADER       (MUS_DP_TITLE + 31)
