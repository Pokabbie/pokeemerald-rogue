...
#define STATUS2_DRAGON_CHEER          (1 << 7)
...
#define STATUS4_AQUA_RING               (1 << 7)   // Was previously in STATUS3
...
#define B_WAIT_TIME_ABSOLUTE_LONG     (B_WAIT_TIME_ABSOLUTE | B_WAIT_TIME_LONG)
#define B_WAIT_TIME_ABSOLUTE_MED      (B_WAIT_TIME_ABSOLUTE | B_WAIT_TIME_MED)
#define B_WAIT_TIME_ABSOLUTE_SHORT    (B_WAIT_TIME_ABSOLUTE | B_WAIT_TIME_SHORT)
#define B_WAIT_TIME_ABSOLUTE_SHORTEST (B_WAIT_TIME_ABSOLUTE | B_WAIT_TIME_SHORTEST)
