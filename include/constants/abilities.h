...
// Rogue
#define ABILITY_FORECAST_DRIZZLE    78
#define ABILITY_FORECAST_DROUGHT    79
#define ABILITY_FORECAST_SNOW       80 // unused outside of EX
...
#define ABILITIES_COUNT_ROGUE       81
