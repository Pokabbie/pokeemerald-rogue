...
// Rogue
#define ABILITY_FORECAST_DRIZZLE    311
#define ABILITY_FORECAST_DROUGHT    312
#define ABILITY_FORECAST_SNOW       313 // unused outside of EX

#define ABILITY_FORECAST_VARIANT_START  ABILITY_FORECAST_DRIZZLE
#define ABILITY_FORECAST_VARIANT_END  ABILITY_FORECAST_SNOW

#define IS_FORECAST_ABILITY(a) (a == ABILITY_FORECAST || (a >= ABILITY_FORECAST_VARIANT_START && a <= ABILITY_FORECAST_VARIANT_END))

#define ABILITIES_COUNT_ROGUE       314
