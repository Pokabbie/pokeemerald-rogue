...
#define HUB_UPGRADE_BERRY_FIELD_EXTRA_FIELD0            (HUB_UPGRADE_FIRST + 15)
#define HUB_UPGRADE_BERRY_FIELD_EXTRA_FIELD1            (HUB_UPGRADE_FIRST + 16)
#define HUB_UPGRADE_BERRY_FIELD_EXTRA_FIELD2            (HUB_UPGRADE_FIRST + 17)
#define HUB_UPGRADE_BERRY_FIELD_HIGHER_YEILD0           (HUB_UPGRADE_FIRST + 18)
#define HUB_UPGRADE_BERRY_FIELD_HIGHER_YEILD1           (HUB_UPGRADE_FIRST + 19)
#define HUB_UPGRADE_BERRY_FIELD_HIGHER_YEILD2           (HUB_UPGRADE_FIRST + 20)

#define HUB_UPGRADE_SAFARI_ZONE_LEGENDS_CAVE            (HUB_UPGRADE_FIRST + 21)

// none for HUB_AREA_RIDE_TRAINING

#define HUB_UPGRADE_MARTS_GENERAL_STOCK                 (HUB_UPGRADE_FIRST + 22)
#define HUB_UPGRADE_MARTS_POKE_BALLS                    (HUB_UPGRADE_FIRST + 23)
#define HUB_UPGRADE_MARTS_POKE_BALLS_STOCK              (HUB_UPGRADE_FIRST + 24)
#define HUB_UPGRADE_MARTS_TMS                           (HUB_UPGRADE_FIRST + 25)
#define HUB_UPGRADE_MARTS_TMS_STOCK                     (HUB_UPGRADE_FIRST + 26)
#define HUB_UPGRADE_MARTS_TRAVELER_BATTLE_ENCHANCERS    (HUB_UPGRADE_FIRST + 27)
#define HUB_UPGRADE_MARTS_TRAVELER_HELD_ITEMS           (HUB_UPGRADE_FIRST + 28)
