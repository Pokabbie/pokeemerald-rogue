...
#define OBJ_EVENT_GFX_UNOVA_GRIMSLY              (OBJ_EVENT_GFX_SINNOH_MAYLENE + 7)
...
#define OBJ_EVENT_GFX_MISC_AROMA_GIRL                      (OBJ_EVENT_GFX_UNOVA_ROXIE + 1)
#define OBJ_EVENT_GFX_MISC_BACKPACKER_F                    (OBJ_EVENT_GFX_UNOVA_ROXIE + 2)
#define OBJ_EVENT_GFX_MISC_BACKPACKER_M                    (OBJ_EVENT_GFX_UNOVA_ROXIE + 3)
#define OBJ_EVENT_GFX_MISC_BUG_CATCHER                     (OBJ_EVENT_GFX_UNOVA_ROXIE + 4)
#define OBJ_EVENT_GFX_MISC_BURGLAR                         (OBJ_EVENT_GFX_UNOVA_ROXIE + 5)
#define OBJ_EVENT_GFX_MISC_CLOWN                           (OBJ_EVENT_GFX_UNOVA_ROXIE + 6)
#define OBJ_EVENT_GFX_MISC_HEX_MANIAC                      (OBJ_EVENT_GFX_UNOVA_ROXIE + 7)
#define OBJ_EVENT_GFX_MISC_KALOS_ENGINEER                  (OBJ_EVENT_GFX_UNOVA_ROXIE + 8)
#define OBJ_EVENT_GFX_MISC_KALOS_WORKER                    (OBJ_EVENT_GFX_UNOVA_ROXIE + 9)
#define OBJ_EVENT_GFX_MISC_LOOKER                          (OBJ_EVENT_GFX_UNOVA_ROXIE + 10)
#define OBJ_EVENT_GFX_MISC_NPC_LADY                        (OBJ_EVENT_GFX_UNOVA_ROXIE + 11)
#define OBJ_EVENT_GFX_MISC_NPC_MYSTERY_GIFT                (OBJ_EVENT_GFX_UNOVA_ROXIE + 12)
#define OBJ_EVENT_GFX_MISC_NPC_TUTOR                       (OBJ_EVENT_GFX_UNOVA_ROXIE + 13)
#define OBJ_EVENT_GFX_MISC_NURSE                           (OBJ_EVENT_GFX_UNOVA_ROXIE + 14)
#define OBJ_EVENT_GFX_MISC_POKE_FAN_F                      (OBJ_EVENT_GFX_UNOVA_ROXIE + 15)
#define OBJ_EVENT_GFX_MISC_PROFESSOR_ELM                   (OBJ_EVENT_GFX_UNOVA_ROXIE + 16)
#define OBJ_EVENT_GFX_MISC_RUIN_MANIAC                     (OBJ_EVENT_GFX_UNOVA_ROXIE + 17)
#define OBJ_EVENT_GFX_MISC_SCIENTIST                       (OBJ_EVENT_GFX_UNOVA_ROXIE + 18)
#define OBJ_EVENT_GFX_MISC_SUPER_NERD                      (OBJ_EVENT_GFX_UNOVA_ROXIE + 19)
#define OBJ_EVENT_GFX_MISC_UNOVA_SCIENTIST_F               (OBJ_EVENT_GFX_UNOVA_ROXIE + 20)
#define OBJ_EVENT_GFX_MISC_VETERAN                         (OBJ_EVENT_GFX_UNOVA_ROXIE + 21)
#define OBJ_EVENT_GFX_MISC_YOUNG_COUPLE_F                  (OBJ_EVENT_GFX_UNOVA_ROXIE + 22)
#define OBJ_EVENT_GFX_MISC_YOUNG_COUPLE_M                  (OBJ_EVENT_GFX_UNOVA_ROXIE + 23)
