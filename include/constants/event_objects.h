...
#define OBJ_EVENT_GFX_FOLLOW_MON_PARTNER         (OBJ_EVENT_GFX_GLITCH_ERMA + 1)
#define OBJ_EVENT_GFX_FOLLOW_MON_0               (OBJ_EVENT_GFX_GLITCH_ERMA + 2)
#define OBJ_EVENT_GFX_FOLLOW_MON_1               (OBJ_EVENT_GFX_GLITCH_ERMA + 3)
#define OBJ_EVENT_GFX_FOLLOW_MON_2               (OBJ_EVENT_GFX_GLITCH_ERMA + 4)
#define OBJ_EVENT_GFX_FOLLOW_MON_3               (OBJ_EVENT_GFX_GLITCH_ERMA + 5)
#define OBJ_EVENT_GFX_FOLLOW_MON_4               (OBJ_EVENT_GFX_GLITCH_ERMA + 6)
#define OBJ_EVENT_GFX_FOLLOW_MON_5               (OBJ_EVENT_GFX_GLITCH_ERMA + 7)
#define OBJ_EVENT_GFX_FOLLOW_MON_6               (OBJ_EVENT_GFX_GLITCH_ERMA + 8)
#define OBJ_EVENT_GFX_FOLLOW_MON_7               (OBJ_EVENT_GFX_GLITCH_ERMA + 9)
#define OBJ_EVENT_GFX_FOLLOW_MON_8               (OBJ_EVENT_GFX_GLITCH_ERMA + 10)
#define OBJ_EVENT_GFX_FOLLOW_MON_9               (OBJ_EVENT_GFX_GLITCH_ERMA + 11)
#define OBJ_EVENT_GFX_FOLLOW_MON_A               (OBJ_EVENT_GFX_GLITCH_ERMA + 12)
#define OBJ_EVENT_GFX_FOLLOW_MON_B               (OBJ_EVENT_GFX_GLITCH_ERMA + 13)
#define OBJ_EVENT_GFX_FOLLOW_MON_C               (OBJ_EVENT_GFX_GLITCH_ERMA + 14)
#define OBJ_EVENT_GFX_FOLLOW_MON_D               (OBJ_EVENT_GFX_GLITCH_ERMA + 15)
#define OBJ_EVENT_GFX_FOLLOW_MON_E               (OBJ_EVENT_GFX_GLITCH_ERMA + 16)
#define OBJ_EVENT_GFX_FOLLOW_MON_F               (OBJ_EVENT_GFX_GLITCH_ERMA + 17)
