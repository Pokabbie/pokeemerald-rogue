...
#define OBJ_EVENT_GFX_ITEM_EVO_STONE             (OBJ_EVENT_GFX_RIVAL_TREVOR + 19)
#define OBJ_EVENT_GFX_ITEM_RARE_CANDY            (OBJ_EVENT_GFX_RIVAL_TREVOR + 20)
#define OBJ_EVENT_GFX_ITEM_MINT                  (OBJ_EVENT_GFX_RIVAL_TREVOR + 21)
#define OBJ_EVENT_GFX_ITEM_MEGA_STONE            (OBJ_EVENT_GFX_RIVAL_TREVOR + 22)
#define OBJ_EVENT_GFX_ITEM_Z_CRYSTAL             (OBJ_EVENT_GFX_RIVAL_TREVOR + 23)
#define OBJ_EVENT_GFX_ITEM_DYNAMAX_BALL          (OBJ_EVENT_GFX_RIVAL_TREVOR + 24)
#define OBJ_EVENT_GFX_ITEM_HEALING               (OBJ_EVENT_GFX_RIVAL_TREVOR + 25)
#define OBJ_EVENT_GFX_GOLD_GRASS                 (OBJ_EVENT_GFX_RIVAL_TREVOR + 26)
