...
#define OBJ_EVENT_GFX_KANTO_AGATHA               (OBJ_EVENT_GFX_ROCKET_M + 1)
#define OBJ_EVENT_GFX_KANTO_BLAINE               (OBJ_EVENT_GFX_ROCKET_M + 2)
#define OBJ_EVENT_GFX_KANTO_BLUE                 (OBJ_EVENT_GFX_ROCKET_M + 3)
#define OBJ_EVENT_GFX_KANTO_BROCK                (OBJ_EVENT_GFX_ROCKET_M + 4)
#define OBJ_EVENT_GFX_KANTO_BRUNO                (OBJ_EVENT_GFX_ROCKET_M + 5)
#define OBJ_EVENT_GFX_KANTO_ERIKA                (OBJ_EVENT_GFX_ROCKET_M + 6)
#define OBJ_EVENT_GFX_KANTO_GIOVANNI             (OBJ_EVENT_GFX_ROCKET_M + 7)
#define OBJ_EVENT_GFX_KANTO_KOGA                 (OBJ_EVENT_GFX_ROCKET_M + 8)
#define OBJ_EVENT_GFX_KANTO_LANCE                (OBJ_EVENT_GFX_ROCKET_M + 9)
#define OBJ_EVENT_GFX_KANTO_LORELEI              (OBJ_EVENT_GFX_ROCKET_M + 10)
#define OBJ_EVENT_GFX_KANTO_LTSURGE              (OBJ_EVENT_GFX_ROCKET_M + 11)
#define OBJ_EVENT_GFX_KANTO_MISTY                (OBJ_EVENT_GFX_ROCKET_M + 12)
#define OBJ_EVENT_GFX_KANTO_PROFOAK              (OBJ_EVENT_GFX_ROCKET_M + 13)
#define OBJ_EVENT_GFX_KANTO_SABRINA              (OBJ_EVENT_GFX_ROCKET_M + 14)
#define OBJ_EVENT_GFX_KANTO_ROCKET_GIOVANNI      (OBJ_EVENT_GFX_ROCKET_M + 15)
...
#define OBJ_EVENT_GFX_PALDEA_BRASSIUS            (OBJ_EVENT_GFX_ALOLA_SOPHOCLES + 1)
#define OBJ_EVENT_GFX_PALDEA_GRUSHA              (OBJ_EVENT_GFX_ALOLA_SOPHOCLES + 2)
#define OBJ_EVENT_GFX_PALDEA_IONO                (OBJ_EVENT_GFX_ALOLA_SOPHOCLES + 3)
#define OBJ_EVENT_GFX_PALDEA_KATY                (OBJ_EVENT_GFX_ALOLA_SOPHOCLES + 4)
#define OBJ_EVENT_GFX_PALDEA_KOFU                (OBJ_EVENT_GFX_ALOLA_SOPHOCLES + 5)
#define OBJ_EVENT_GFX_PALDEA_LARRY               (OBJ_EVENT_GFX_ALOLA_SOPHOCLES + 6)
#define OBJ_EVENT_GFX_PALDEA_RYME                (OBJ_EVENT_GFX_ALOLA_SOPHOCLES + 7)
#define OBJ_EVENT_GFX_PALDEA_GEETA               (OBJ_EVENT_GFX_ALOLA_SOPHOCLES + 8)
#define OBJ_EVENT_GFX_PALDEA_HASSEL              (OBJ_EVENT_GFX_ALOLA_SOPHOCLES + 9)
#define OBJ_EVENT_GFX_PALDEA_POPPY               (OBJ_EVENT_GFX_ALOLA_SOPHOCLES + 10)
#define OBJ_EVENT_GFX_PALDEA_RIKA                (OBJ_EVENT_GFX_ALOLA_SOPHOCLES + 11)
#define OBJ_EVENT_GFX_PALDEA_TULIP               (OBJ_EVENT_GFX_ALOLA_SOPHOCLES + 12)

#define OBJ_EVENT_GFX_GALAR_ALLISTER             (OBJ_EVENT_GFX_PALDEA_TULIP + 2)
#define OBJ_EVENT_GFX_GALAR_BEA                  (OBJ_EVENT_GFX_PALDEA_TULIP + 3)
#define OBJ_EVENT_GFX_GALAR_GORDIE               (OBJ_EVENT_GFX_PALDEA_TULIP + 4)
#define OBJ_EVENT_GFX_GALAR_KABU                 (OBJ_EVENT_GFX_PALDEA_TULIP + 5)
#define OBJ_EVENT_GFX_GALAR_LEON                 (OBJ_EVENT_GFX_PALDEA_TULIP + 6)
#define OBJ_EVENT_GFX_GALAR_MELONY               (OBJ_EVENT_GFX_PALDEA_TULIP + 7)
#define OBJ_EVENT_GFX_GALAR_MILO                 (OBJ_EVENT_GFX_PALDEA_TULIP + 8)
#define OBJ_EVENT_GFX_GALAR_NESSA                (OBJ_EVENT_GFX_PALDEA_TULIP + 9)
#define OBJ_EVENT_GFX_GALAR_OPAL                 (OBJ_EVENT_GFX_PALDEA_TULIP + 10)
#define OBJ_EVENT_GFX_GALAR_PIERS                (OBJ_EVENT_GFX_PALDEA_TULIP + 11)
#define OBJ_EVENT_GFX_GALAR_RAIHAN               (OBJ_EVENT_GFX_PALDEA_TULIP + 12)

#define OBJ_EVENT_GFX_MISC_AROMA_GIRL            (OBJ_EVENT_GFX_GALAR_RAIHAN + 1)
#define OBJ_EVENT_GFX_MISC_BACKPACKER_F          (OBJ_EVENT_GFX_GALAR_RAIHAN + 2)
#define OBJ_EVENT_GFX_MISC_BACKPACKER_M          (OBJ_EVENT_GFX_GALAR_RAIHAN + 3)
#define OBJ_EVENT_GFX_MISC_BUG_CATCHER           (OBJ_EVENT_GFX_GALAR_RAIHAN + 4)
#define OBJ_EVENT_GFX_MISC_BURGLAR               (OBJ_EVENT_GFX_GALAR_RAIHAN + 5)
#define OBJ_EVENT_GFX_MISC_CHANNELER             (OBJ_EVENT_GFX_GALAR_RAIHAN + 6)
#define OBJ_EVENT_GFX_MISC_CLOWN                 (OBJ_EVENT_GFX_GALAR_RAIHAN + 7)
#define OBJ_EVENT_GFX_MISC_HEX_MANIAC            (OBJ_EVENT_GFX_GALAR_RAIHAN + 8)
#define OBJ_EVENT_GFX_MISC_KALOS_ENGINEER        (OBJ_EVENT_GFX_GALAR_RAIHAN + 9)
#define OBJ_EVENT_GFX_MISC_KALOS_WORKER          (OBJ_EVENT_GFX_GALAR_RAIHAN + 10)
#define OBJ_EVENT_GFX_MISC_LOOKER                (OBJ_EVENT_GFX_GALAR_RAIHAN + 11)
#define OBJ_EVENT_GFX_MISC_NPC_LADY              (OBJ_EVENT_GFX_GALAR_RAIHAN + 12)
#define OBJ_EVENT_GFX_MISC_NPC_MYSTERY_GIFT      (OBJ_EVENT_GFX_GALAR_RAIHAN + 13)
#define OBJ_EVENT_GFX_MISC_NPC_TUTOR             (OBJ_EVENT_GFX_GALAR_RAIHAN + 14)
#define OBJ_EVENT_GFX_MISC_NURSE                 (OBJ_EVENT_GFX_GALAR_RAIHAN + 15)
#define OBJ_EVENT_GFX_MISC_PEONIA                (OBJ_EVENT_GFX_GALAR_RAIHAN + 16)
#define OBJ_EVENT_GFX_MISC_POKE_FAN_F            (OBJ_EVENT_GFX_GALAR_RAIHAN + 17)
#define OBJ_EVENT_GFX_MISC_PROFESSOR_ELM         (OBJ_EVENT_GFX_GALAR_RAIHAN + 18)
#define OBJ_EVENT_GFX_MISC_RUIN_MANIAC           (OBJ_EVENT_GFX_GALAR_RAIHAN + 19)
#define OBJ_EVENT_GFX_MISC_SCIENTIST             (OBJ_EVENT_GFX_GALAR_RAIHAN + 20)
#define OBJ_EVENT_GFX_MISC_SUPER_NERD            (OBJ_EVENT_GFX_GALAR_RAIHAN + 21)
#define OBJ_EVENT_GFX_MISC_UNOVA_SCIENTIST_F     (OBJ_EVENT_GFX_GALAR_RAIHAN + 22)
#define OBJ_EVENT_GFX_MISC_VETERAN               (OBJ_EVENT_GFX_GALAR_RAIHAN + 23)
#define OBJ_EVENT_GFX_MISC_YOUNG_COUPLE_F        (OBJ_EVENT_GFX_GALAR_RAIHAN + 24)
#define OBJ_EVENT_GFX_MISC_YOUNG_COUPLE_M        (OBJ_EVENT_GFX_GALAR_RAIHAN + 25)
#define OBJ_EVENT_GFX_MISC_HEX_MANIAC_SECRET     (OBJ_EVENT_GFX_GALAR_RAIHAN + 26)

#define OBJ_EVENT_GFX_RIVAL_AVERY                (OBJ_EVENT_GFX_MISC_HEX_MANIAC_SECRET + 1)
#define OBJ_EVENT_GFX_RIVAL_BARRY                (OBJ_EVENT_GFX_MISC_HEX_MANIAC_SECRET + 2)
#define OBJ_EVENT_GFX_RIVAL_BEDE                 (OBJ_EVENT_GFX_MISC_HEX_MANIAC_SECRET + 3)
#define OBJ_EVENT_GFX_RIVAL_BIANCA               (OBJ_EVENT_GFX_MISC_HEX_MANIAC_SECRET + 4)
#define OBJ_EVENT_GFX_RIVAL_CHEREN               (OBJ_EVENT_GFX_MISC_HEX_MANIAC_SECRET + 5)
#define OBJ_EVENT_GFX_RIVAL_GLADION              (OBJ_EVENT_GFX_MISC_HEX_MANIAC_SECRET + 6)
#define OBJ_EVENT_GFX_RIVAL_HAU                  (OBJ_EVENT_GFX_MISC_HEX_MANIAC_SECRET + 7)
#define OBJ_EVENT_GFX_RIVAL_HOP                  (OBJ_EVENT_GFX_MISC_HEX_MANIAC_SECRET + 8)
#define OBJ_EVENT_GFX_RIVAL_HUGH                 (OBJ_EVENT_GFX_MISC_HEX_MANIAC_SECRET + 9)
#define OBJ_EVENT_GFX_RIVAL_KLARA                (OBJ_EVENT_GFX_MISC_HEX_MANIAC_SECRET + 10)
#define OBJ_EVENT_GFX_RIVAL_MARNIE               (OBJ_EVENT_GFX_MISC_HEX_MANIAC_SECRET + 11)
#define OBJ_EVENT_GFX_RIVAL_N                    (OBJ_EVENT_GFX_MISC_HEX_MANIAC_SECRET + 12)
#define OBJ_EVENT_GFX_RIVAL_SHAUNA               (OBJ_EVENT_GFX_MISC_HEX_MANIAC_SECRET + 13)
#define OBJ_EVENT_GFX_RIVAL_SILVER               (OBJ_EVENT_GFX_MISC_HEX_MANIAC_SECRET + 14)
#define OBJ_EVENT_GFX_RIVAL_TIERNO               (OBJ_EVENT_GFX_MISC_HEX_MANIAC_SECRET + 15)
#define OBJ_EVENT_GFX_RIVAL_TREVOR               (OBJ_EVENT_GFX_MISC_HEX_MANIAC_SECRET + 16)
#define OBJ_EVENT_GFX_RIVAL_NEMONA               (OBJ_EVENT_GFX_MISC_HEX_MANIAC_SECRET + 17)
#define OBJ_EVENT_GFX_RIVAL_PENNY                (OBJ_EVENT_GFX_MISC_HEX_MANIAC_SECRET + 18)
#define OBJ_EVENT_GFX_RIVAL_ARVEN                (OBJ_EVENT_GFX_MISC_HEX_MANIAC_SECRET + 19)

#define OBJ_EVENT_GFX_PC                         (OBJ_EVENT_GFX_RIVAL_ARVEN + 1)
#define OBJ_EVENT_GFX_PC_STAND                   (OBJ_EVENT_GFX_RIVAL_ARVEN + 2)
#define OBJ_EVENT_GFX_PHONE_BOOTH                (OBJ_EVENT_GFX_RIVAL_ARVEN + 3)
#define OBJ_EVENT_GFX_POKEBLOCK_MIXER            (OBJ_EVENT_GFX_RIVAL_ARVEN + 4)
#define OBJ_EVENT_GFX_FOOD_PIE                   (OBJ_EVENT_GFX_RIVAL_ARVEN + 5)
#define OBJ_EVENT_GFX_SMALL_SIGN                 (OBJ_EVENT_GFX_RIVAL_ARVEN + 6)
#define OBJ_EVENT_GFX_DEVIL_MAN                  (OBJ_EVENT_GFX_RIVAL_ARVEN + 7)
#define OBJ_EVENT_GFX_WORK_TABLE                 (OBJ_EVENT_GFX_RIVAL_ARVEN + 8)
#define OBJ_EVENT_GFX_QUEST_BOARD                (OBJ_EVENT_GFX_RIVAL_ARVEN + 9)
#define OBJ_EVENT_GFX_STATUE_LEVEL_0             (OBJ_EVENT_GFX_RIVAL_ARVEN + 10)
#define OBJ_EVENT_GFX_STATUE_LEVEL_1             (OBJ_EVENT_GFX_RIVAL_ARVEN + 11)
#define OBJ_EVENT_GFX_STATUE_LEVEL_2             (OBJ_EVENT_GFX_RIVAL_ARVEN + 12)
#define OBJ_EVENT_GFX_STATUE_LEVEL_3             (OBJ_EVENT_GFX_RIVAL_ARVEN + 13)
#define OBJ_EVENT_GFX_ITEM_SILVER_TM             (OBJ_EVENT_GFX_RIVAL_ARVEN + 14)
#define OBJ_EVENT_GFX_ITEM_GOLD_TM               (OBJ_EVENT_GFX_RIVAL_ARVEN + 15)
#define OBJ_EVENT_GFX_ITEM_POKE_BALL             (OBJ_EVENT_GFX_RIVAL_ARVEN + 16)
#define OBJ_EVENT_GFX_ITEM_MEDICINE              (OBJ_EVENT_GFX_RIVAL_ARVEN + 17)
#define OBJ_EVENT_GFX_ITEM_HOLD_ITEM             (OBJ_EVENT_GFX_RIVAL_ARVEN + 18)
#define OBJ_EVENT_GFX_ITEM_MASTER_BALL           (OBJ_EVENT_GFX_RIVAL_ARVEN + 19)
#define OBJ_EVENT_GFX_ITEM_EVO_STONE             (OBJ_EVENT_GFX_RIVAL_ARVEN + 20)
#define OBJ_EVENT_GFX_ITEM_RARE_CANDY            (OBJ_EVENT_GFX_RIVAL_ARVEN + 21)
#define OBJ_EVENT_GFX_ITEM_MINT                  (OBJ_EVENT_GFX_RIVAL_ARVEN + 22)
#define OBJ_EVENT_GFX_ITEM_MEGA_STONE            (OBJ_EVENT_GFX_RIVAL_ARVEN + 23)
#define OBJ_EVENT_GFX_ITEM_Z_CRYSTAL             (OBJ_EVENT_GFX_RIVAL_ARVEN + 24)
#define OBJ_EVENT_GFX_ITEM_DYNAMAX_BALL          (OBJ_EVENT_GFX_RIVAL_ARVEN + 25)
#define OBJ_EVENT_GFX_ITEM_HEALING               (OBJ_EVENT_GFX_RIVAL_ARVEN + 26)
#define OBJ_EVENT_GFX_ITEM_TERA_ORB              (OBJ_EVENT_GFX_RIVAL_ARVEN + 27)
#define OBJ_EVENT_GFX_ITEM_TERA_SHARD            (OBJ_EVENT_GFX_RIVAL_ARVEN + 28)
#define OBJ_EVENT_GFX_GOLD_GRASS                 (OBJ_EVENT_GFX_RIVAL_ARVEN + 29)
#define OBJ_EVENT_GFX_FLAG_ADVENTURE             (OBJ_EVENT_GFX_RIVAL_ARVEN + 30)

#define OBJ_EVENT_GFX_BRENDAN_ALT                (OBJ_EVENT_GFX_FLAG_ADVENTURE + 1)
#define OBJ_EVENT_GFX_MAY_ALT                    (OBJ_EVENT_GFX_FLAG_ADVENTURE + 2)
#define OBJ_EVENT_GFX_RED_ALT                    (OBJ_EVENT_GFX_FLAG_ADVENTURE + 3)
#define OBJ_EVENT_GFX_LEAF_ALT                   (OBJ_EVENT_GFX_FLAG_ADVENTURE + 4)
#define OBJ_EVENT_GFX_LYRA_ALT                   (OBJ_EVENT_GFX_FLAG_ADVENTURE + 5)
#define OBJ_EVENT_GFX_ETHAN_ALT                  (OBJ_EVENT_GFX_FLAG_ADVENTURE + 6)
...
#define OBJ_EVENT_GFX_RIVAL_RED                  (OBJ_EVENT_GFX_GLITCH_TAILS + 1)
#define OBJ_EVENT_GFX_RIVAL_LEAF                 (OBJ_EVENT_GFX_GLITCH_TAILS + 2)
#define OBJ_EVENT_GFX_RIVAL_ETHAN                (OBJ_EVENT_GFX_GLITCH_TAILS + 3)
#define OBJ_EVENT_GFX_RIVAL_LYRA                 (OBJ_EVENT_GFX_GLITCH_TAILS + 4)
#define OBJ_EVENT_GFX_RIVAL_BRENDAN              (OBJ_EVENT_GFX_GLITCH_TAILS + 5)
#define OBJ_EVENT_GFX_RIVAL_MAY                  (OBJ_EVENT_GFX_GLITCH_TAILS + 6)
#define OBJ_EVENT_GFX_RIVAL_LUCAS                (OBJ_EVENT_GFX_GLITCH_TAILS + 7)
#define OBJ_EVENT_GFX_RIVAL_DAWN                 (OBJ_EVENT_GFX_GLITCH_TAILS + 8)
#define OBJ_EVENT_GFX_RIVAL_HILBERT              (OBJ_EVENT_GFX_GLITCH_TAILS + 9)
#define OBJ_EVENT_GFX_RIVAL_HILDA                (OBJ_EVENT_GFX_GLITCH_TAILS + 10)
#define OBJ_EVENT_GFX_RIVAL_NATE                 (OBJ_EVENT_GFX_GLITCH_TAILS + 11)
#define OBJ_EVENT_GFX_RIVAL_ROSA                 (OBJ_EVENT_GFX_GLITCH_TAILS + 12)
#define OBJ_EVENT_GFX_RIVAL_CALEM                (OBJ_EVENT_GFX_GLITCH_TAILS + 13)
#define OBJ_EVENT_GFX_RIVAL_SERENA               (OBJ_EVENT_GFX_GLITCH_TAILS + 14)
#define OBJ_EVENT_GFX_RIVAL_ELIO                 (OBJ_EVENT_GFX_GLITCH_TAILS + 15)
#define OBJ_EVENT_GFX_RIVAL_SELENE               (OBJ_EVENT_GFX_GLITCH_TAILS + 16)
#define OBJ_EVENT_GFX_RIVAL_VICTOR               (OBJ_EVENT_GFX_GLITCH_TAILS + 17)
#define OBJ_EVENT_GFX_RIVAL_GLORIA               (OBJ_EVENT_GFX_GLITCH_TAILS + 18)

#define OBJ_EVENT_GFX_TEAM_FLARE_GRUNT_F         (OBJ_EVENT_GFX_RIVAL_GLORIA + 1)
#define OBJ_EVENT_GFX_TEAM_FLARE_GRUNT_M         (OBJ_EVENT_GFX_RIVAL_GLORIA + 2)
#define OBJ_EVENT_GFX_TEAM_FLARE_LYSANDER        (OBJ_EVENT_GFX_RIVAL_GLORIA + 3)
#define OBJ_EVENT_GFX_TEAM_GALACTIC_CYRUS        (OBJ_EVENT_GFX_RIVAL_GLORIA + 4)
#define OBJ_EVENT_GFX_TEAM_GALACTIC_GRUNT_F      (OBJ_EVENT_GFX_RIVAL_GLORIA + 5)
#define OBJ_EVENT_GFX_TEAM_GALACTIC_GRUNT_M      (OBJ_EVENT_GFX_RIVAL_GLORIA + 6)
#define OBJ_EVENT_GFX_TEAM_NEO_PLASMA_COLRESS    (OBJ_EVENT_GFX_RIVAL_GLORIA + 7)
#define OBJ_EVENT_GFX_TEAM_NEO_PLASMA_GRUNT_F    (OBJ_EVENT_GFX_RIVAL_GLORIA + 8)
#define OBJ_EVENT_GFX_TEAM_NEO_PLASMA_GRUNT_M    (OBJ_EVENT_GFX_RIVAL_GLORIA + 9)
#define OBJ_EVENT_GFX_TEAM_PLASMA_GHETSIS        (OBJ_EVENT_GFX_RIVAL_GLORIA + 10)
#define OBJ_EVENT_GFX_TEAM_PLASMA_GRUNT_F        (OBJ_EVENT_GFX_RIVAL_GLORIA + 11)
#define OBJ_EVENT_GFX_TEAM_PLASMA_GRUNT_M        (OBJ_EVENT_GFX_RIVAL_GLORIA + 12)
#define OBJ_EVENT_GFX_TEAM_ROCKET_ARCHER         (OBJ_EVENT_GFX_RIVAL_GLORIA + 13)
#define OBJ_EVENT_GFX_TEAM_ROCKET_ARIANA         (OBJ_EVENT_GFX_RIVAL_GLORIA + 14)
#define OBJ_EVENT_GFX_TEAM_ROCKET_PETREL         (OBJ_EVENT_GFX_RIVAL_GLORIA + 15)
#define OBJ_EVENT_GFX_TEAM_ROCKET_PROTON         (OBJ_EVENT_GFX_RIVAL_GLORIA + 16)
