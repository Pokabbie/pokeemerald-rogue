...
#define OBJ_EVENT_GFX_MISC_CLOWN                 (OBJ_EVENT_GFX_GALAR_RAIHAN + 6)
#define OBJ_EVENT_GFX_MISC_HEX_MANIAC            (OBJ_EVENT_GFX_GALAR_RAIHAN + 7)
#define OBJ_EVENT_GFX_MISC_KALOS_ENGINEER        (OBJ_EVENT_GFX_GALAR_RAIHAN + 8)
#define OBJ_EVENT_GFX_MISC_KALOS_WORKER          (OBJ_EVENT_GFX_GALAR_RAIHAN + 9)
#define OBJ_EVENT_GFX_MISC_LOOKER                (OBJ_EVENT_GFX_GALAR_RAIHAN + 10)
#define OBJ_EVENT_GFX_MISC_NPC_LADY              (OBJ_EVENT_GFX_GALAR_RAIHAN + 11)
#define OBJ_EVENT_GFX_MISC_NPC_MYSTERY_GIFT      (OBJ_EVENT_GFX_GALAR_RAIHAN + 12)
#define OBJ_EVENT_GFX_MISC_NPC_TUTOR             (OBJ_EVENT_GFX_GALAR_RAIHAN + 13)
#define OBJ_EVENT_GFX_MISC_NURSE                 (OBJ_EVENT_GFX_GALAR_RAIHAN + 14)
#define OBJ_EVENT_GFX_MISC_POKE_FAN_F            (OBJ_EVENT_GFX_GALAR_RAIHAN + 15)
#define OBJ_EVENT_GFX_MISC_PROFESSOR_ELM         (OBJ_EVENT_GFX_GALAR_RAIHAN + 16)
#define OBJ_EVENT_GFX_MISC_RUIN_MANIAC           (OBJ_EVENT_GFX_GALAR_RAIHAN + 17)
#define OBJ_EVENT_GFX_MISC_SCIENTIST             (OBJ_EVENT_GFX_GALAR_RAIHAN + 18)
#define OBJ_EVENT_GFX_MISC_SUPER_NERD            (OBJ_EVENT_GFX_GALAR_RAIHAN + 19)
#define OBJ_EVENT_GFX_MISC_UNOVA_SCIENTIST_F     (OBJ_EVENT_GFX_GALAR_RAIHAN + 20)
#define OBJ_EVENT_GFX_MISC_VETERAN               (OBJ_EVENT_GFX_GALAR_RAIHAN + 21)
#define OBJ_EVENT_GFX_MISC_YOUNG_COUPLE_F        (OBJ_EVENT_GFX_GALAR_RAIHAN + 22)
#define OBJ_EVENT_GFX_MISC_YOUNG_COUPLE_M        (OBJ_EVENT_GFX_GALAR_RAIHAN + 23)
