...
#define OBJ_EVENT_GFX_ITEM_ESCAPE_ROPE           (OBJ_EVENT_GFX_RIVAL_ARVEN + 31)
#define OBJ_EVENT_GFX_ITEM_TREASURE              (OBJ_EVENT_GFX_RIVAL_ARVEN + 32)
#define OBJ_EVENT_GFX_GRASS_DEFAULT              (OBJ_EVENT_GFX_RIVAL_ARVEN + 33)
#define OBJ_EVENT_GFX_GOLD_GRASS                 (OBJ_EVENT_GFX_RIVAL_ARVEN + 34)
#define OBJ_EVENT_GFX_FLAG_ADVENTURE             (OBJ_EVENT_GFX_RIVAL_ARVEN + 35)
...
#define OBJ_EVENT_GFX_GLITCH_POKABBIE            (OBJ_EVENT_GFX_ETHAN_ALT + 6)
#define OBJ_EVENT_GFX_GLITCH_NACHO               (OBJ_EVENT_GFX_ETHAN_ALT + 7)
...
#define OBJ_EVENT_GFX_WILD_DEN_BUG               (OBJ_EVENT_GFX_ROUTE_WATER + 1)
#define OBJ_EVENT_GFX_WILD_DEN_DARK              (OBJ_EVENT_GFX_ROUTE_WATER + 2)
#define OBJ_EVENT_GFX_WILD_DEN_DRAGON            (OBJ_EVENT_GFX_ROUTE_WATER + 3)
#define OBJ_EVENT_GFX_WILD_DEN_ELECTRIC          (OBJ_EVENT_GFX_ROUTE_WATER + 4)
#define OBJ_EVENT_GFX_WILD_DEN_FAIRY             (OBJ_EVENT_GFX_ROUTE_WATER + 5)
#define OBJ_EVENT_GFX_WILD_DEN_FIGHTING          (OBJ_EVENT_GFX_ROUTE_WATER + 6)
#define OBJ_EVENT_GFX_WILD_DEN_FIRE              (OBJ_EVENT_GFX_ROUTE_WATER + 7)
#define OBJ_EVENT_GFX_WILD_DEN_FLYING            (OBJ_EVENT_GFX_ROUTE_WATER + 8)
#define OBJ_EVENT_GFX_WILD_DEN_GHOST             (OBJ_EVENT_GFX_ROUTE_WATER + 9)
#define OBJ_EVENT_GFX_WILD_DEN_GRASS             (OBJ_EVENT_GFX_ROUTE_WATER + 10)
#define OBJ_EVENT_GFX_WILD_DEN_GROUND            (OBJ_EVENT_GFX_ROUTE_WATER + 11)
#define OBJ_EVENT_GFX_WILD_DEN_ICE               (OBJ_EVENT_GFX_ROUTE_WATER + 12)
#define OBJ_EVENT_GFX_WILD_DEN_MYSTERY           (OBJ_EVENT_GFX_ROUTE_WATER + 13)
#define OBJ_EVENT_GFX_WILD_DEN_NORMAL            (OBJ_EVENT_GFX_ROUTE_WATER + 14)
#define OBJ_EVENT_GFX_WILD_DEN_POISON            (OBJ_EVENT_GFX_ROUTE_WATER + 15)
#define OBJ_EVENT_GFX_WILD_DEN_PSYCHIC           (OBJ_EVENT_GFX_ROUTE_WATER + 16)
#define OBJ_EVENT_GFX_WILD_DEN_ROCK              (OBJ_EVENT_GFX_ROUTE_WATER + 17)
#define OBJ_EVENT_GFX_WILD_DEN_STEEL             (OBJ_EVENT_GFX_ROUTE_WATER + 18)
#define OBJ_EVENT_GFX_WILD_DEN_WATER             (OBJ_EVENT_GFX_ROUTE_WATER + 19)


#define OBJ_EVENT_GFX_FOLLOW_MON_PARTNER         (OBJ_EVENT_GFX_WILD_DEN_WATER + 1)
#define OBJ_EVENT_GFX_FOLLOW_MON_0               (OBJ_EVENT_GFX_WILD_DEN_WATER + 2)
#define OBJ_EVENT_GFX_FOLLOW_MON_1               (OBJ_EVENT_GFX_WILD_DEN_WATER + 3)
#define OBJ_EVENT_GFX_FOLLOW_MON_2               (OBJ_EVENT_GFX_WILD_DEN_WATER + 4)
#define OBJ_EVENT_GFX_FOLLOW_MON_3               (OBJ_EVENT_GFX_WILD_DEN_WATER + 5)
#define OBJ_EVENT_GFX_FOLLOW_MON_4               (OBJ_EVENT_GFX_WILD_DEN_WATER + 6)
#define OBJ_EVENT_GFX_FOLLOW_MON_5               (OBJ_EVENT_GFX_WILD_DEN_WATER + 7)
