...
#define OBJ_EVENT_GFX_ITEM_SILVER_TM             (OBJ_EVENT_GFX_JOHTO_RED + 5)
#define OBJ_EVENT_GFX_ITEM_GOLD_TM               (OBJ_EVENT_GFX_JOHTO_RED + 6)
#define OBJ_EVENT_GFX_ITEM_POKE_BALL             (OBJ_EVENT_GFX_JOHTO_RED + 7)
#define OBJ_EVENT_GFX_ITEM_MEDICINE              (OBJ_EVENT_GFX_JOHTO_RED + 8)
#define OBJ_EVENT_GFX_ITEM_HOLD_ITEM             (OBJ_EVENT_GFX_JOHTO_RED + 9)
#define OBJ_EVENT_GFX_ITEM_EVO_STONE             (OBJ_EVENT_GFX_JOHTO_RED + 10)
#define OBJ_EVENT_GFX_ITEM_MEGA_STONE            (OBJ_EVENT_GFX_JOHTO_RED + 11)
#define OBJ_EVENT_GFX_ITEM_Z_CRYSTAL             (OBJ_EVENT_GFX_JOHTO_RED + 12)
