...
#define OBJ_EVENT_GFX_LYRA                       (OBJ_EVENT_GFX_VAR_F + 11)
#define OBJ_EVENT_GFX_LYRA_MACH_BIKE             (OBJ_EVENT_GFX_VAR_F + 12)
#define OBJ_EVENT_GFX_LYRA_ACRO_BIKE             (OBJ_EVENT_GFX_VAR_F + 13)
#define OBJ_EVENT_GFX_LYRA_SURFING               (OBJ_EVENT_GFX_VAR_F + 14)
#define OBJ_EVENT_GFX_LYRA_FIELD_MOVE            (OBJ_EVENT_GFX_VAR_F + 15)
#define OBJ_EVENT_GFX_LYRA_FISHING               (OBJ_EVENT_GFX_VAR_F + 16)

#define OBJ_EVENT_GFX_ETHAN                      (OBJ_EVENT_GFX_VAR_F + 17)
#define OBJ_EVENT_GFX_ETHAN_MACH_BIKE            (OBJ_EVENT_GFX_VAR_F + 18)
#define OBJ_EVENT_GFX_ETHAN_ACRO_BIKE            (OBJ_EVENT_GFX_VAR_F + 19)
#define OBJ_EVENT_GFX_ETHAN_SURFING              (OBJ_EVENT_GFX_VAR_F + 20)
#define OBJ_EVENT_GFX_ETHAN_FIELD_MOVE           (OBJ_EVENT_GFX_VAR_F + 21)
#define OBJ_EVENT_GFX_ETHAN_FISHING              (OBJ_EVENT_GFX_VAR_F + 22)

// TODO - Move these above
#define OBJ_EVENT_GFX_BRENDAN_RIDING             (OBJ_EVENT_GFX_VAR_F + 23)
#define OBJ_EVENT_GFX_MAY_RIDING                 (OBJ_EVENT_GFX_VAR_F + 24)
#define OBJ_EVENT_GFX_LEAF_RIDING                (OBJ_EVENT_GFX_VAR_F + 25)
#define OBJ_EVENT_GFX_RED_RIDING                 (OBJ_EVENT_GFX_VAR_F + 26)
#define OBJ_EVENT_GFX_LYRA_RIDING                (OBJ_EVENT_GFX_VAR_F + 27)
#define OBJ_EVENT_GFX_ETHAN_RIDING               (OBJ_EVENT_GFX_VAR_F + 28)
...
//#define OBJ_EVENT_GFX_GLITCH_RAVEN               (OBJ_EVENT_GFX_QUEST_BOARD + ?)

#define OBJ_EVENT_GFX_BACKPACKER_F               (OBJ_EVENT_GFX_QUEST_BOARD + 9)
#define OBJ_EVENT_GFX_BACKPACKER_M               (OBJ_EVENT_GFX_QUEST_BOARD + 10)
#define OBJ_EVENT_GFX_BUILDER                    (OBJ_EVENT_GFX_QUEST_BOARD + 11)
