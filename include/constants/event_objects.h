...
#define OBJ_EVENT_GFX_KANTO_AGATHA               (OBJ_EVENT_GFX_ETHAN_FISHING + 1)
#define OBJ_EVENT_GFX_KANTO_BLAINE               (OBJ_EVENT_GFX_ETHAN_FISHING + 2)
#define OBJ_EVENT_GFX_KANTO_BLUE                 (OBJ_EVENT_GFX_ETHAN_FISHING + 3)
#define OBJ_EVENT_GFX_KANTO_BROCK                (OBJ_EVENT_GFX_ETHAN_FISHING + 4)
#define OBJ_EVENT_GFX_KANTO_BRUNO                (OBJ_EVENT_GFX_ETHAN_FISHING + 5)
#define OBJ_EVENT_GFX_KANTO_ERIKA                (OBJ_EVENT_GFX_ETHAN_FISHING + 6)
#define OBJ_EVENT_GFX_KANTO_GIOVANNI             (OBJ_EVENT_GFX_ETHAN_FISHING + 7)
#define OBJ_EVENT_GFX_KANTO_KOGA                 (OBJ_EVENT_GFX_ETHAN_FISHING + 8)
#define OBJ_EVENT_GFX_KANTO_LANCE                (OBJ_EVENT_GFX_ETHAN_FISHING + 9)
#define OBJ_EVENT_GFX_KANTO_LORELEI              (OBJ_EVENT_GFX_ETHAN_FISHING + 10)
#define OBJ_EVENT_GFX_KANTO_LTSURGE              (OBJ_EVENT_GFX_ETHAN_FISHING + 11)
#define OBJ_EVENT_GFX_KANTO_MISTY                (OBJ_EVENT_GFX_ETHAN_FISHING + 12)
#define OBJ_EVENT_GFX_KANTO_PROFOAK              (OBJ_EVENT_GFX_ETHAN_FISHING + 13)
#define OBJ_EVENT_GFX_KANTO_SABRINA              (OBJ_EVENT_GFX_ETHAN_FISHING + 14)
