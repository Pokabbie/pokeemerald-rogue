...
#define OBJ_EVENT_GFX_DEVIL_MAN                  (OBJ_EVENT_GFX_RIVAL_TREVOR + 4)
#define OBJ_EVENT_GFX_WORK_TABLE                 (OBJ_EVENT_GFX_RIVAL_TREVOR + 5)
#define OBJ_EVENT_GFX_QUEST_BOARD                (OBJ_EVENT_GFX_RIVAL_TREVOR + 6)
#define OBJ_EVENT_GFX_ITEM_SILVER_TM             (OBJ_EVENT_GFX_RIVAL_TREVOR + 7)
#define OBJ_EVENT_GFX_ITEM_GOLD_TM               (OBJ_EVENT_GFX_RIVAL_TREVOR + 8)
#define OBJ_EVENT_GFX_ITEM_POKE_BALL             (OBJ_EVENT_GFX_RIVAL_TREVOR + 9)
#define OBJ_EVENT_GFX_ITEM_MEDICINE              (OBJ_EVENT_GFX_RIVAL_TREVOR + 10)
#define OBJ_EVENT_GFX_ITEM_HOLD_ITEM             (OBJ_EVENT_GFX_RIVAL_TREVOR + 11)
#define OBJ_EVENT_GFX_ITEM_EVO_STONE             (OBJ_EVENT_GFX_RIVAL_TREVOR + 12)
#define OBJ_EVENT_GFX_ITEM_RARE_CANDY            (OBJ_EVENT_GFX_RIVAL_TREVOR + 13)
#define OBJ_EVENT_GFX_ITEM_MINT                  (OBJ_EVENT_GFX_RIVAL_TREVOR + 14)
#define OBJ_EVENT_GFX_ITEM_MEGA_STONE            (OBJ_EVENT_GFX_RIVAL_TREVOR + 15)
#define OBJ_EVENT_GFX_ITEM_Z_CRYSTAL             (OBJ_EVENT_GFX_RIVAL_TREVOR + 16)
#define OBJ_EVENT_GFX_ITEM_DYNAMAX_BALL          (OBJ_EVENT_GFX_RIVAL_TREVOR + 17)
#define OBJ_EVENT_GFX_ITEM_HEALING               (OBJ_EVENT_GFX_RIVAL_TREVOR + 18)
#define OBJ_EVENT_GFX_GOLD_GRASS                 (OBJ_EVENT_GFX_RIVAL_TREVOR + 19)
