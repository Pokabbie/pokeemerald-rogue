...
#define OBJ_EVENT_GFX_PC                         (OBJ_EVENT_GFX_SINNOH_MAYLENE + 1)
#define OBJ_EVENT_GFX_DEVIL_MAN                  (OBJ_EVENT_GFX_SINNOH_MAYLENE + 2)
#define OBJ_EVENT_GFX_WORK_TABLE                 (OBJ_EVENT_GFX_SINNOH_MAYLENE + 3)
#define OBJ_EVENT_GFX_QUEST_BOARD                (OBJ_EVENT_GFX_SINNOH_MAYLENE + 4)
#define OBJ_EVENT_GFX_ITEM_SILVER_TM             (OBJ_EVENT_GFX_SINNOH_MAYLENE + 5)
#define OBJ_EVENT_GFX_ITEM_GOLD_TM               (OBJ_EVENT_GFX_SINNOH_MAYLENE + 6)
#define OBJ_EVENT_GFX_ITEM_POKE_BALL             (OBJ_EVENT_GFX_SINNOH_MAYLENE + 7)
#define OBJ_EVENT_GFX_ITEM_MEDICINE              (OBJ_EVENT_GFX_SINNOH_MAYLENE + 8)
#define OBJ_EVENT_GFX_ITEM_HOLD_ITEM             (OBJ_EVENT_GFX_SINNOH_MAYLENE + 9)
#define OBJ_EVENT_GFX_ITEM_EVO_STONE             (OBJ_EVENT_GFX_SINNOH_MAYLENE + 10)
#define OBJ_EVENT_GFX_ITEM_MEGA_STONE            (OBJ_EVENT_GFX_SINNOH_MAYLENE + 11)
#define OBJ_EVENT_GFX_ITEM_Z_CRYSTAL             (OBJ_EVENT_GFX_SINNOH_MAYLENE + 12)
...
#define OBJ_EVENT_GFX_BACKPACKER_F               (OBJ_EVENT_GFX_ETHAN_ALT + 3)
#define OBJ_EVENT_GFX_BACKPACKER_M               (OBJ_EVENT_GFX_ETHAN_ALT + 4)
#define OBJ_EVENT_GFX_BUILDER                    (OBJ_EVENT_GFX_ETHAN_ALT + 5)

#define OBJ_EVENT_GFX_ROUTE_BUG                  (OBJ_EVENT_GFX_BUILDER + 1)
#define OBJ_EVENT_GFX_ROUTE_DARK                 (OBJ_EVENT_GFX_BUILDER + 2)
#define OBJ_EVENT_GFX_ROUTE_DRAGON               (OBJ_EVENT_GFX_BUILDER + 3)
#define OBJ_EVENT_GFX_ROUTE_ELECTRIC             (OBJ_EVENT_GFX_BUILDER + 4)
#define OBJ_EVENT_GFX_ROUTE_FAIRY                (OBJ_EVENT_GFX_BUILDER + 5)
#define OBJ_EVENT_GFX_ROUTE_FIGHTING             (OBJ_EVENT_GFX_BUILDER + 6)
#define OBJ_EVENT_GFX_ROUTE_FIRE                 (OBJ_EVENT_GFX_BUILDER + 7)
#define OBJ_EVENT_GFX_ROUTE_FLYING               (OBJ_EVENT_GFX_BUILDER + 8)
#define OBJ_EVENT_GFX_ROUTE_GHOST                (OBJ_EVENT_GFX_BUILDER + 9)
#define OBJ_EVENT_GFX_ROUTE_GRASS                (OBJ_EVENT_GFX_BUILDER + 10)
#define OBJ_EVENT_GFX_ROUTE_GROUND               (OBJ_EVENT_GFX_BUILDER + 11)
#define OBJ_EVENT_GFX_ROUTE_ICE                  (OBJ_EVENT_GFX_BUILDER + 12)
#define OBJ_EVENT_GFX_ROUTE_MYSTERY              (OBJ_EVENT_GFX_BUILDER + 13)
#define OBJ_EVENT_GFX_ROUTE_NORMAL               (OBJ_EVENT_GFX_BUILDER + 14)
#define OBJ_EVENT_GFX_ROUTE_POISON               (OBJ_EVENT_GFX_BUILDER + 15)
#define OBJ_EVENT_GFX_ROUTE_PSYCHIC              (OBJ_EVENT_GFX_BUILDER + 16)
#define OBJ_EVENT_GFX_ROUTE_ROCK                 (OBJ_EVENT_GFX_BUILDER + 17)
#define OBJ_EVENT_GFX_ROUTE_STEEL                (OBJ_EVENT_GFX_BUILDER + 18)
#define OBJ_EVENT_GFX_ROUTE_WATER                (OBJ_EVENT_GFX_BUILDER + 19)
