...
#define OBJ_EVENT_GFX_MISC_PEONIA                (OBJ_EVENT_GFX_GALAR_RAIHAN + 15)
#define OBJ_EVENT_GFX_MISC_POKE_FAN_F            (OBJ_EVENT_GFX_GALAR_RAIHAN + 16)
#define OBJ_EVENT_GFX_MISC_PROFESSOR_ELM         (OBJ_EVENT_GFX_GALAR_RAIHAN + 17)
#define OBJ_EVENT_GFX_MISC_RUIN_MANIAC           (OBJ_EVENT_GFX_GALAR_RAIHAN + 18)
#define OBJ_EVENT_GFX_MISC_SCIENTIST             (OBJ_EVENT_GFX_GALAR_RAIHAN + 19)
#define OBJ_EVENT_GFX_MISC_SUPER_NERD            (OBJ_EVENT_GFX_GALAR_RAIHAN + 20)
#define OBJ_EVENT_GFX_MISC_UNOVA_SCIENTIST_F     (OBJ_EVENT_GFX_GALAR_RAIHAN + 21)
#define OBJ_EVENT_GFX_MISC_VETERAN               (OBJ_EVENT_GFX_GALAR_RAIHAN + 22)
#define OBJ_EVENT_GFX_MISC_YOUNG_COUPLE_F        (OBJ_EVENT_GFX_GALAR_RAIHAN + 23)
#define OBJ_EVENT_GFX_MISC_YOUNG_COUPLE_M        (OBJ_EVENT_GFX_GALAR_RAIHAN + 24)
