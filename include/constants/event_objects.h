...
#define OBJ_EVENT_GFX_FOOD_PIE                   (OBJ_EVENT_GFX_RIVAL_ARVEN + 6)
#define OBJ_EVENT_GFX_SMALL_SIGN                 (OBJ_EVENT_GFX_RIVAL_ARVEN + 7)
#define OBJ_EVENT_GFX_DEVIL_MAN                  (OBJ_EVENT_GFX_RIVAL_ARVEN + 8)
#define OBJ_EVENT_GFX_WORK_TABLE                 (OBJ_EVENT_GFX_RIVAL_ARVEN + 9)
#define OBJ_EVENT_GFX_QUEST_BOARD                (OBJ_EVENT_GFX_RIVAL_ARVEN + 10)
#define OBJ_EVENT_GFX_STATUE_LEVEL_0             (OBJ_EVENT_GFX_RIVAL_ARVEN + 11)
#define OBJ_EVENT_GFX_STATUE_LEVEL_1             (OBJ_EVENT_GFX_RIVAL_ARVEN + 12)
#define OBJ_EVENT_GFX_STATUE_LEVEL_2             (OBJ_EVENT_GFX_RIVAL_ARVEN + 13)
#define OBJ_EVENT_GFX_STATUE_LEVEL_3             (OBJ_EVENT_GFX_RIVAL_ARVEN + 14)
#define OBJ_EVENT_GFX_ITEM_SILVER_TM             (OBJ_EVENT_GFX_RIVAL_ARVEN + 15)
#define OBJ_EVENT_GFX_ITEM_GOLD_TM               (OBJ_EVENT_GFX_RIVAL_ARVEN + 16)
#define OBJ_EVENT_GFX_ITEM_POKE_BALL             (OBJ_EVENT_GFX_RIVAL_ARVEN + 17)
#define OBJ_EVENT_GFX_ITEM_MEDICINE              (OBJ_EVENT_GFX_RIVAL_ARVEN + 18)
#define OBJ_EVENT_GFX_ITEM_HOLD_ITEM             (OBJ_EVENT_GFX_RIVAL_ARVEN + 19)
#define OBJ_EVENT_GFX_ITEM_MASTER_BALL           (OBJ_EVENT_GFX_RIVAL_ARVEN + 20)
#define OBJ_EVENT_GFX_ITEM_EVO_STONE             (OBJ_EVENT_GFX_RIVAL_ARVEN + 21)
#define OBJ_EVENT_GFX_ITEM_RARE_CANDY            (OBJ_EVENT_GFX_RIVAL_ARVEN + 22)
#define OBJ_EVENT_GFX_ITEM_MINT                  (OBJ_EVENT_GFX_RIVAL_ARVEN + 23)
#define OBJ_EVENT_GFX_ITEM_MEGA_STONE            (OBJ_EVENT_GFX_RIVAL_ARVEN + 24)
#define OBJ_EVENT_GFX_ITEM_Z_CRYSTAL             (OBJ_EVENT_GFX_RIVAL_ARVEN + 25)
#define OBJ_EVENT_GFX_ITEM_DYNAMAX_BALL          (OBJ_EVENT_GFX_RIVAL_ARVEN + 26)
#define OBJ_EVENT_GFX_ITEM_HEALING               (OBJ_EVENT_GFX_RIVAL_ARVEN + 27)
#define OBJ_EVENT_GFX_ITEM_TERA_ORB              (OBJ_EVENT_GFX_RIVAL_ARVEN + 28)
#define OBJ_EVENT_GFX_ITEM_TERA_SHARD            (OBJ_EVENT_GFX_RIVAL_ARVEN + 29)
#define OBJ_EVENT_GFX_GRASS_DEFAULT              (OBJ_EVENT_GFX_RIVAL_ARVEN + 30)
#define OBJ_EVENT_GFX_GOLD_GRASS                 (OBJ_EVENT_GFX_RIVAL_ARVEN + 31)
#define OBJ_EVENT_GFX_FLAG_ADVENTURE             (OBJ_EVENT_GFX_RIVAL_ARVEN + 32)
