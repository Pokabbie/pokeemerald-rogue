...
#define OBJ_EVENT_GFX_BIKER                      (OBJ_EVENT_GFX_BUG_CATCHER_RIDING + 1)
#define OBJ_EVENT_GFX_OLD_MAN_2                  (OBJ_EVENT_GFX_BUG_CATCHER_RIDING + 2)
#define OBJ_EVENT_GFX_ROCKET_F                   (OBJ_EVENT_GFX_BUG_CATCHER_RIDING + 3)
#define OBJ_EVENT_GFX_ROCKET_M                   (OBJ_EVENT_GFX_BUG_CATCHER_RIDING + 4)
