...
#define OBJ_EVENT_GFX_KANTO_AGATHA               (OBJ_EVENT_GFX_BUG_CATCHER_RIDING + 1)
#define OBJ_EVENT_GFX_KANTO_BLAINE               (OBJ_EVENT_GFX_BUG_CATCHER_RIDING + 2)
#define OBJ_EVENT_GFX_KANTO_BLUE                 (OBJ_EVENT_GFX_BUG_CATCHER_RIDING + 3)
#define OBJ_EVENT_GFX_KANTO_BROCK                (OBJ_EVENT_GFX_BUG_CATCHER_RIDING + 4)
#define OBJ_EVENT_GFX_KANTO_BRUNO                (OBJ_EVENT_GFX_BUG_CATCHER_RIDING + 5)
#define OBJ_EVENT_GFX_KANTO_ERIKA                (OBJ_EVENT_GFX_BUG_CATCHER_RIDING + 6)
#define OBJ_EVENT_GFX_KANTO_GIOVANNI             (OBJ_EVENT_GFX_BUG_CATCHER_RIDING + 7)
#define OBJ_EVENT_GFX_KANTO_KOGA                 (OBJ_EVENT_GFX_BUG_CATCHER_RIDING + 8)
#define OBJ_EVENT_GFX_KANTO_LANCE                (OBJ_EVENT_GFX_BUG_CATCHER_RIDING + 9)
#define OBJ_EVENT_GFX_KANTO_LORELEI              (OBJ_EVENT_GFX_BUG_CATCHER_RIDING + 10)
#define OBJ_EVENT_GFX_KANTO_LTSURGE              (OBJ_EVENT_GFX_BUG_CATCHER_RIDING + 11)
#define OBJ_EVENT_GFX_KANTO_MISTY                (OBJ_EVENT_GFX_BUG_CATCHER_RIDING + 12)
#define OBJ_EVENT_GFX_KANTO_PROFOAK              (OBJ_EVENT_GFX_BUG_CATCHER_RIDING + 13)
#define OBJ_EVENT_GFX_KANTO_SABRINA              (OBJ_EVENT_GFX_BUG_CATCHER_RIDING + 14)
...
#define OBJ_EVENT_GFX_ITEM_MEGA_STONE            (OBJ_EVENT_GFX_RIVAL_TREVOR + 13)
#define OBJ_EVENT_GFX_ITEM_Z_CRYSTAL             (OBJ_EVENT_GFX_RIVAL_TREVOR + 14)
#define OBJ_EVENT_GFX_GOLD_GRASS                 (OBJ_EVENT_GFX_RIVAL_TREVOR + 15)
...
#define OBJ_EVENT_GFX_ROUTE_BUG                  (OBJ_EVENT_GFX_GLITCH_TAILS + 1)
#define OBJ_EVENT_GFX_ROUTE_DARK                 (OBJ_EVENT_GFX_GLITCH_TAILS + 2)
#define OBJ_EVENT_GFX_ROUTE_DRAGON               (OBJ_EVENT_GFX_GLITCH_TAILS + 3)
#define OBJ_EVENT_GFX_ROUTE_ELECTRIC             (OBJ_EVENT_GFX_GLITCH_TAILS + 4)
#define OBJ_EVENT_GFX_ROUTE_FAIRY                (OBJ_EVENT_GFX_GLITCH_TAILS + 5)
#define OBJ_EVENT_GFX_ROUTE_FIGHTING             (OBJ_EVENT_GFX_GLITCH_TAILS + 6)
#define OBJ_EVENT_GFX_ROUTE_FIRE                 (OBJ_EVENT_GFX_GLITCH_TAILS + 7)
#define OBJ_EVENT_GFX_ROUTE_FLYING               (OBJ_EVENT_GFX_GLITCH_TAILS + 8)
#define OBJ_EVENT_GFX_ROUTE_GHOST                (OBJ_EVENT_GFX_GLITCH_TAILS + 9)
#define OBJ_EVENT_GFX_ROUTE_GRASS                (OBJ_EVENT_GFX_GLITCH_TAILS + 10)
#define OBJ_EVENT_GFX_ROUTE_GROUND               (OBJ_EVENT_GFX_GLITCH_TAILS + 11)
#define OBJ_EVENT_GFX_ROUTE_ICE                  (OBJ_EVENT_GFX_GLITCH_TAILS + 12)
#define OBJ_EVENT_GFX_ROUTE_MYSTERY              (OBJ_EVENT_GFX_GLITCH_TAILS + 13)
#define OBJ_EVENT_GFX_ROUTE_NORMAL               (OBJ_EVENT_GFX_GLITCH_TAILS + 14)
#define OBJ_EVENT_GFX_ROUTE_POISON               (OBJ_EVENT_GFX_GLITCH_TAILS + 15)
#define OBJ_EVENT_GFX_ROUTE_PSYCHIC              (OBJ_EVENT_GFX_GLITCH_TAILS + 16)
#define OBJ_EVENT_GFX_ROUTE_ROCK                 (OBJ_EVENT_GFX_GLITCH_TAILS + 17)
#define OBJ_EVENT_GFX_ROUTE_STEEL                (OBJ_EVENT_GFX_GLITCH_TAILS + 18)
#define OBJ_EVENT_GFX_ROUTE_WATER                (OBJ_EVENT_GFX_GLITCH_TAILS + 19)
