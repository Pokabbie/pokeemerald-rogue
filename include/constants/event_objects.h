...
#define OBJ_EVENT_GFX_RIVAL_AVERY                (OBJ_EVENT_GFX_MISC_YOUNG_COUPLE_M + 1)
#define OBJ_EVENT_GFX_RIVAL_BARRY                (OBJ_EVENT_GFX_MISC_YOUNG_COUPLE_M + 2)
#define OBJ_EVENT_GFX_RIVAL_BEDE                 (OBJ_EVENT_GFX_MISC_YOUNG_COUPLE_M + 3)
#define OBJ_EVENT_GFX_RIVAL_BIANCA               (OBJ_EVENT_GFX_MISC_YOUNG_COUPLE_M + 4)
#define OBJ_EVENT_GFX_RIVAL_CHEREN               (OBJ_EVENT_GFX_MISC_YOUNG_COUPLE_M + 5)
#define OBJ_EVENT_GFX_RIVAL_GLADION              (OBJ_EVENT_GFX_MISC_YOUNG_COUPLE_M + 6)
#define OBJ_EVENT_GFX_RIVAL_HAU                  (OBJ_EVENT_GFX_MISC_YOUNG_COUPLE_M + 7)
#define OBJ_EVENT_GFX_RIVAL_HOP                  (OBJ_EVENT_GFX_MISC_YOUNG_COUPLE_M + 8)
#define OBJ_EVENT_GFX_RIVAL_HUGH                 (OBJ_EVENT_GFX_MISC_YOUNG_COUPLE_M + 9)
#define OBJ_EVENT_GFX_RIVAL_KLARA                (OBJ_EVENT_GFX_MISC_YOUNG_COUPLE_M + 10)
#define OBJ_EVENT_GFX_RIVAL_MARNIE               (OBJ_EVENT_GFX_MISC_YOUNG_COUPLE_M + 11)
#define OBJ_EVENT_GFX_RIVAL_N                    (OBJ_EVENT_GFX_MISC_YOUNG_COUPLE_M + 12)
#define OBJ_EVENT_GFX_RIVAL_SHAUNA               (OBJ_EVENT_GFX_MISC_YOUNG_COUPLE_M + 13)
#define OBJ_EVENT_GFX_RIVAL_SILVER               (OBJ_EVENT_GFX_MISC_YOUNG_COUPLE_M + 14)
#define OBJ_EVENT_GFX_RIVAL_TIERNO               (OBJ_EVENT_GFX_MISC_YOUNG_COUPLE_M + 15)
#define OBJ_EVENT_GFX_RIVAL_TREVOR               (OBJ_EVENT_GFX_MISC_YOUNG_COUPLE_M + 16)

#define OBJ_EVENT_GFX_PC                         (OBJ_EVENT_GFX_RIVAL_TREVOR + 1)
#define OBJ_EVENT_GFX_PC_STAND                   (OBJ_EVENT_GFX_RIVAL_TREVOR + 2)
#define OBJ_EVENT_GFX_POKEBLOCK_MIXER            (OBJ_EVENT_GFX_RIVAL_TREVOR + 3)
#define OBJ_EVENT_GFX_FOOD_PIE                   (OBJ_EVENT_GFX_RIVAL_TREVOR + 4)
#define OBJ_EVENT_GFX_SMALL_SIGN                 (OBJ_EVENT_GFX_RIVAL_TREVOR + 5)
#define OBJ_EVENT_GFX_DEVIL_MAN                  (OBJ_EVENT_GFX_RIVAL_TREVOR + 6)
#define OBJ_EVENT_GFX_WORK_TABLE                 (OBJ_EVENT_GFX_RIVAL_TREVOR + 7)
#define OBJ_EVENT_GFX_QUEST_BOARD                (OBJ_EVENT_GFX_RIVAL_TREVOR + 8)
#define OBJ_EVENT_GFX_STATUE_LEVEL_0             (OBJ_EVENT_GFX_RIVAL_TREVOR + 9)
#define OBJ_EVENT_GFX_STATUE_LEVEL_1             (OBJ_EVENT_GFX_RIVAL_TREVOR + 10)
#define OBJ_EVENT_GFX_STATUE_LEVEL_2             (OBJ_EVENT_GFX_RIVAL_TREVOR + 11)
#define OBJ_EVENT_GFX_STATUE_LEVEL_3             (OBJ_EVENT_GFX_RIVAL_TREVOR + 12)
#define OBJ_EVENT_GFX_ITEM_SILVER_TM             (OBJ_EVENT_GFX_RIVAL_TREVOR + 13)
#define OBJ_EVENT_GFX_ITEM_GOLD_TM               (OBJ_EVENT_GFX_RIVAL_TREVOR + 14)
#define OBJ_EVENT_GFX_ITEM_POKE_BALL             (OBJ_EVENT_GFX_RIVAL_TREVOR + 15)
#define OBJ_EVENT_GFX_ITEM_MEDICINE              (OBJ_EVENT_GFX_RIVAL_TREVOR + 16)
#define OBJ_EVENT_GFX_ITEM_HOLD_ITEM             (OBJ_EVENT_GFX_RIVAL_TREVOR + 17)
#define OBJ_EVENT_GFX_ITEM_EVO_STONE             (OBJ_EVENT_GFX_RIVAL_TREVOR + 18)
#define OBJ_EVENT_GFX_ITEM_RARE_CANDY            (OBJ_EVENT_GFX_RIVAL_TREVOR + 19)
#define OBJ_EVENT_GFX_ITEM_MINT                  (OBJ_EVENT_GFX_RIVAL_TREVOR + 20)
#define OBJ_EVENT_GFX_ITEM_MEGA_STONE            (OBJ_EVENT_GFX_RIVAL_TREVOR + 21)
#define OBJ_EVENT_GFX_ITEM_Z_CRYSTAL             (OBJ_EVENT_GFX_RIVAL_TREVOR + 22)
#define OBJ_EVENT_GFX_ITEM_DYNAMAX_BALL          (OBJ_EVENT_GFX_RIVAL_TREVOR + 23)
#define OBJ_EVENT_GFX_ITEM_HEALING               (OBJ_EVENT_GFX_RIVAL_TREVOR + 24)
#define OBJ_EVENT_GFX_GOLD_GRASS                 (OBJ_EVENT_GFX_RIVAL_TREVOR + 25)

#define OBJ_EVENT_GFX_BRENDAN_ALT                (OBJ_EVENT_GFX_GOLD_GRASS + 1)
#define OBJ_EVENT_GFX_MAY_ALT                    (OBJ_EVENT_GFX_GOLD_GRASS + 2)
#define OBJ_EVENT_GFX_RED_ALT                    (OBJ_EVENT_GFX_GOLD_GRASS + 3)
#define OBJ_EVENT_GFX_LEAF_ALT                   (OBJ_EVENT_GFX_GOLD_GRASS + 4)
#define OBJ_EVENT_GFX_LYRA_ALT                   (OBJ_EVENT_GFX_GOLD_GRASS + 5)
#define OBJ_EVENT_GFX_ETHAN_ALT                  (OBJ_EVENT_GFX_GOLD_GRASS + 6)
...
#define OBJ_EVENT_GFX_ROUTE_BUG                  (OBJ_EVENT_GFX_RIVAL_GLORIA + 1)
#define OBJ_EVENT_GFX_ROUTE_DARK                 (OBJ_EVENT_GFX_RIVAL_GLORIA + 2)
#define OBJ_EVENT_GFX_ROUTE_DRAGON               (OBJ_EVENT_GFX_RIVAL_GLORIA + 3)
#define OBJ_EVENT_GFX_ROUTE_ELECTRIC             (OBJ_EVENT_GFX_RIVAL_GLORIA + 4)
#define OBJ_EVENT_GFX_ROUTE_FAIRY                (OBJ_EVENT_GFX_RIVAL_GLORIA + 5)
#define OBJ_EVENT_GFX_ROUTE_FIGHTING             (OBJ_EVENT_GFX_RIVAL_GLORIA + 6)
#define OBJ_EVENT_GFX_ROUTE_FIRE                 (OBJ_EVENT_GFX_RIVAL_GLORIA + 7)
#define OBJ_EVENT_GFX_ROUTE_FLYING               (OBJ_EVENT_GFX_RIVAL_GLORIA + 8)
#define OBJ_EVENT_GFX_ROUTE_GHOST                (OBJ_EVENT_GFX_RIVAL_GLORIA + 9)
#define OBJ_EVENT_GFX_ROUTE_GRASS                (OBJ_EVENT_GFX_RIVAL_GLORIA + 10)
#define OBJ_EVENT_GFX_ROUTE_GROUND               (OBJ_EVENT_GFX_RIVAL_GLORIA + 11)
#define OBJ_EVENT_GFX_ROUTE_ICE                  (OBJ_EVENT_GFX_RIVAL_GLORIA + 12)
#define OBJ_EVENT_GFX_ROUTE_MYSTERY              (OBJ_EVENT_GFX_RIVAL_GLORIA + 13)
#define OBJ_EVENT_GFX_ROUTE_NORMAL               (OBJ_EVENT_GFX_RIVAL_GLORIA + 14)
#define OBJ_EVENT_GFX_ROUTE_POISON               (OBJ_EVENT_GFX_RIVAL_GLORIA + 15)
#define OBJ_EVENT_GFX_ROUTE_PSYCHIC              (OBJ_EVENT_GFX_RIVAL_GLORIA + 16)
#define OBJ_EVENT_GFX_ROUTE_ROCK                 (OBJ_EVENT_GFX_RIVAL_GLORIA + 17)
#define OBJ_EVENT_GFX_ROUTE_STEEL                (OBJ_EVENT_GFX_RIVAL_GLORIA + 18)
#define OBJ_EVENT_GFX_ROUTE_WATER                (OBJ_EVENT_GFX_RIVAL_GLORIA + 19)
