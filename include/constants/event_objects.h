...
#define OBJ_EVENT_GFX_BRENDAN_ALT                (OBJ_EVENT_GFX_DECOR_WARDROBE + 1)
#define OBJ_EVENT_GFX_MAY_ALT                    (OBJ_EVENT_GFX_DECOR_WARDROBE + 2)
#define OBJ_EVENT_GFX_RED_ALT                    (OBJ_EVENT_GFX_DECOR_WARDROBE + 3)
#define OBJ_EVENT_GFX_LEAF_ALT                   (OBJ_EVENT_GFX_DECOR_WARDROBE + 4)
#define OBJ_EVENT_GFX_LYRA_ALT                   (OBJ_EVENT_GFX_DECOR_WARDROBE + 5)
#define OBJ_EVENT_GFX_ETHAN_ALT                  (OBJ_EVENT_GFX_DECOR_WARDROBE + 6)
