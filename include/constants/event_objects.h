...
#define OBJ_EVENT_GFX_MAY_RIDING                 (OBJ_EVENT_GFX_PLAYER_LAST + 1)
#define OBJ_EVENT_GFX_BRENDAN_RIDING             (OBJ_EVENT_GFX_PLAYER_LAST + 2)
...
#define OBJ_EVENT_GFX_KANTO_AGATHA               (OBJ_EVENT_GFX_ETHAN_RIDING + 1)
#define OBJ_EVENT_GFX_KANTO_BLAINE               (OBJ_EVENT_GFX_ETHAN_RIDING + 2)
#define OBJ_EVENT_GFX_KANTO_BLUE                 (OBJ_EVENT_GFX_ETHAN_RIDING + 3)
#define OBJ_EVENT_GFX_KANTO_BROCK                (OBJ_EVENT_GFX_ETHAN_RIDING + 4)
#define OBJ_EVENT_GFX_KANTO_BRUNO                (OBJ_EVENT_GFX_ETHAN_RIDING + 5)
#define OBJ_EVENT_GFX_KANTO_ERIKA                (OBJ_EVENT_GFX_ETHAN_RIDING + 6)
#define OBJ_EVENT_GFX_KANTO_GIOVANNI             (OBJ_EVENT_GFX_ETHAN_RIDING + 7)
#define OBJ_EVENT_GFX_KANTO_KOGA                 (OBJ_EVENT_GFX_ETHAN_RIDING + 8)
#define OBJ_EVENT_GFX_KANTO_LANCE                (OBJ_EVENT_GFX_ETHAN_RIDING + 9)
#define OBJ_EVENT_GFX_KANTO_LORELEI              (OBJ_EVENT_GFX_ETHAN_RIDING + 10)
#define OBJ_EVENT_GFX_KANTO_LTSURGE              (OBJ_EVENT_GFX_ETHAN_RIDING + 11)
#define OBJ_EVENT_GFX_KANTO_MISTY                (OBJ_EVENT_GFX_ETHAN_RIDING + 12)
#define OBJ_EVENT_GFX_KANTO_PROFOAK              (OBJ_EVENT_GFX_ETHAN_RIDING + 13)
#define OBJ_EVENT_GFX_KANTO_SABRINA              (OBJ_EVENT_GFX_ETHAN_RIDING + 14)

#define OBJ_EVENT_GFX_JOHTO_BUGSY                (OBJ_EVENT_GFX_KANTO_SABRINA + 1)
#define OBJ_EVENT_GFX_JOHTO_CLAIR                (OBJ_EVENT_GFX_KANTO_SABRINA + 2)
#define OBJ_EVENT_GFX_JOHTO_CHUCK                (OBJ_EVENT_GFX_KANTO_SABRINA + 3)
#define OBJ_EVENT_GFX_JOHTO_FALKNER              (OBJ_EVENT_GFX_KANTO_SABRINA + 4)
#define OBJ_EVENT_GFX_JOHTO_JASMINE              (OBJ_EVENT_GFX_KANTO_SABRINA + 5)
#define OBJ_EVENT_GFX_JOHTO_KAREN                (OBJ_EVENT_GFX_KANTO_SABRINA + 6)
#define OBJ_EVENT_GFX_JOHTO_MORTY                (OBJ_EVENT_GFX_KANTO_SABRINA + 7)
#define OBJ_EVENT_GFX_JOHTO_PRYCE                (OBJ_EVENT_GFX_KANTO_SABRINA + 8)
#define OBJ_EVENT_GFX_JOHTO_WHITNEY              (OBJ_EVENT_GFX_KANTO_SABRINA + 9)
#define OBJ_EVENT_GFX_JOHTO_WILL                 (OBJ_EVENT_GFX_KANTO_SABRINA + 10)
#define OBJ_EVENT_GFX_JOHTO_RED                  (OBJ_EVENT_GFX_KANTO_SABRINA + 11)
...
#define OBJ_EVENT_GFX_MISC_AROMA_GIRL                      (OBJ_EVENT_GFX_SINNOH_MAYLENE + 1)
#define OBJ_EVENT_GFX_MISC_BACKPACKER_F                    (OBJ_EVENT_GFX_SINNOH_MAYLENE + 2)
#define OBJ_EVENT_GFX_MISC_BACKPACKER_M                    (OBJ_EVENT_GFX_SINNOH_MAYLENE + 3)
#define OBJ_EVENT_GFX_MISC_BUG_CATCHER                     (OBJ_EVENT_GFX_SINNOH_MAYLENE + 4)
#define OBJ_EVENT_GFX_MISC_BURGLAR                         (OBJ_EVENT_GFX_SINNOH_MAYLENE + 5)
#define OBJ_EVENT_GFX_MISC_CLOWN                           (OBJ_EVENT_GFX_SINNOH_MAYLENE + 6)
#define OBJ_EVENT_GFX_MISC_HEX_MANIAC                      (OBJ_EVENT_GFX_SINNOH_MAYLENE + 7)
#define OBJ_EVENT_GFX_MISC_KALOS_ENGINEER                  (OBJ_EVENT_GFX_SINNOH_MAYLENE + 8)
#define OBJ_EVENT_GFX_MISC_KALOS_WORKER                    (OBJ_EVENT_GFX_SINNOH_MAYLENE + 9)
#define OBJ_EVENT_GFX_MISC_LOOKER                          (OBJ_EVENT_GFX_SINNOH_MAYLENE + 10)
#define OBJ_EVENT_GFX_MISC_NPC_LADY                        (OBJ_EVENT_GFX_SINNOH_MAYLENE + 11)
#define OBJ_EVENT_GFX_MISC_NPC_MYSTERY_GIFT                (OBJ_EVENT_GFX_SINNOH_MAYLENE + 12)
#define OBJ_EVENT_GFX_MISC_NPC_TUTOR                       (OBJ_EVENT_GFX_SINNOH_MAYLENE + 13)
#define OBJ_EVENT_GFX_MISC_NURSE                           (OBJ_EVENT_GFX_SINNOH_MAYLENE + 14)
#define OBJ_EVENT_GFX_MISC_POKE_FAN_F                      (OBJ_EVENT_GFX_SINNOH_MAYLENE + 15)
#define OBJ_EVENT_GFX_MISC_PROFESSOR_ELM                   (OBJ_EVENT_GFX_SINNOH_MAYLENE + 16)
#define OBJ_EVENT_GFX_MISC_RUIN_MANIAC                     (OBJ_EVENT_GFX_SINNOH_MAYLENE + 17)
#define OBJ_EVENT_GFX_MISC_SCIENTIST                       (OBJ_EVENT_GFX_SINNOH_MAYLENE + 18)
#define OBJ_EVENT_GFX_MISC_SUPER_NERD                      (OBJ_EVENT_GFX_SINNOH_MAYLENE + 19)
#define OBJ_EVENT_GFX_MISC_UNOVA_SCIENTIST_F               (OBJ_EVENT_GFX_SINNOH_MAYLENE + 20)
#define OBJ_EVENT_GFX_MISC_VETERAN                         (OBJ_EVENT_GFX_SINNOH_MAYLENE + 21)
#define OBJ_EVENT_GFX_MISC_YOUNG_COUPLE_F                  (OBJ_EVENT_GFX_SINNOH_MAYLENE + 22)
#define OBJ_EVENT_GFX_MISC_YOUNG_COUPLE_M                  (OBJ_EVENT_GFX_SINNOH_MAYLENE + 23)

#define OBJ_EVENT_GFX_PC                         (OBJ_EVENT_GFX_MISC_YOUNG_COUPLE_M + 1)
#define OBJ_EVENT_GFX_DEVIL_MAN                  (OBJ_EVENT_GFX_MISC_YOUNG_COUPLE_M + 2)
#define OBJ_EVENT_GFX_WORK_TABLE                 (OBJ_EVENT_GFX_MISC_YOUNG_COUPLE_M + 3)
#define OBJ_EVENT_GFX_QUEST_BOARD                (OBJ_EVENT_GFX_MISC_YOUNG_COUPLE_M + 4)
#define OBJ_EVENT_GFX_ITEM_SILVER_TM             (OBJ_EVENT_GFX_MISC_YOUNG_COUPLE_M + 5)
#define OBJ_EVENT_GFX_ITEM_GOLD_TM               (OBJ_EVENT_GFX_MISC_YOUNG_COUPLE_M + 6)
#define OBJ_EVENT_GFX_ITEM_POKE_BALL             (OBJ_EVENT_GFX_MISC_YOUNG_COUPLE_M + 7)
#define OBJ_EVENT_GFX_ITEM_MEDICINE              (OBJ_EVENT_GFX_MISC_YOUNG_COUPLE_M + 8)
#define OBJ_EVENT_GFX_ITEM_HOLD_ITEM             (OBJ_EVENT_GFX_MISC_YOUNG_COUPLE_M + 9)
#define OBJ_EVENT_GFX_ITEM_EVO_STONE             (OBJ_EVENT_GFX_MISC_YOUNG_COUPLE_M + 10)
#define OBJ_EVENT_GFX_ITEM_MEGA_STONE            (OBJ_EVENT_GFX_MISC_YOUNG_COUPLE_M + 11)
#define OBJ_EVENT_GFX_ITEM_Z_CRYSTAL             (OBJ_EVENT_GFX_MISC_YOUNG_COUPLE_M + 12)

#define OBJ_EVENT_GFX_BRENDAN_ALT                (OBJ_EVENT_GFX_ITEM_Z_CRYSTAL + 1)
#define OBJ_EVENT_GFX_MAY_ALT                    (OBJ_EVENT_GFX_ITEM_Z_CRYSTAL + 2)
#define OBJ_EVENT_GFX_RED_ALT                    (OBJ_EVENT_GFX_ITEM_Z_CRYSTAL + 3)
#define OBJ_EVENT_GFX_LEAF_ALT                   (OBJ_EVENT_GFX_ITEM_Z_CRYSTAL + 4)
#define OBJ_EVENT_GFX_LYRA_ALT                   (OBJ_EVENT_GFX_ITEM_Z_CRYSTAL + 5)
#define OBJ_EVENT_GFX_ETHAN_ALT                  (OBJ_EVENT_GFX_ITEM_Z_CRYSTAL + 6)

#define OBJ_EVENT_GFX_GLITCH_KATE                (OBJ_EVENT_GFX_ETHAN_ALT + 1)
#define OBJ_EVENT_GFX_GLITCH_ERMA                (OBJ_EVENT_GFX_ETHAN_ALT + 2)
//#define OBJ_EVENT_GFX_GLITCH_RAVEN               (OBJ_EVENT_GFX_ETHAN_ALT + ?)

#define OBJ_EVENT_GFX_ROUTE_BUG                  (OBJ_EVENT_GFX_GLITCH_ERMA + 1)
#define OBJ_EVENT_GFX_ROUTE_DARK                 (OBJ_EVENT_GFX_GLITCH_ERMA + 2)
#define OBJ_EVENT_GFX_ROUTE_DRAGON               (OBJ_EVENT_GFX_GLITCH_ERMA + 3)
#define OBJ_EVENT_GFX_ROUTE_ELECTRIC             (OBJ_EVENT_GFX_GLITCH_ERMA + 4)
#define OBJ_EVENT_GFX_ROUTE_FAIRY                (OBJ_EVENT_GFX_GLITCH_ERMA + 5)
#define OBJ_EVENT_GFX_ROUTE_FIGHTING             (OBJ_EVENT_GFX_GLITCH_ERMA + 6)
#define OBJ_EVENT_GFX_ROUTE_FIRE                 (OBJ_EVENT_GFX_GLITCH_ERMA + 7)
#define OBJ_EVENT_GFX_ROUTE_FLYING               (OBJ_EVENT_GFX_GLITCH_ERMA + 8)
#define OBJ_EVENT_GFX_ROUTE_GHOST                (OBJ_EVENT_GFX_GLITCH_ERMA + 9)
#define OBJ_EVENT_GFX_ROUTE_GRASS                (OBJ_EVENT_GFX_GLITCH_ERMA + 10)
#define OBJ_EVENT_GFX_ROUTE_GROUND               (OBJ_EVENT_GFX_GLITCH_ERMA + 11)
#define OBJ_EVENT_GFX_ROUTE_ICE                  (OBJ_EVENT_GFX_GLITCH_ERMA + 12)
#define OBJ_EVENT_GFX_ROUTE_MYSTERY              (OBJ_EVENT_GFX_GLITCH_ERMA + 13)
#define OBJ_EVENT_GFX_ROUTE_NORMAL               (OBJ_EVENT_GFX_GLITCH_ERMA + 14)
#define OBJ_EVENT_GFX_ROUTE_POISON               (OBJ_EVENT_GFX_GLITCH_ERMA + 15)
#define OBJ_EVENT_GFX_ROUTE_PSYCHIC              (OBJ_EVENT_GFX_GLITCH_ERMA + 16)
#define OBJ_EVENT_GFX_ROUTE_ROCK                 (OBJ_EVENT_GFX_GLITCH_ERMA + 17)
#define OBJ_EVENT_GFX_ROUTE_STEEL                (OBJ_EVENT_GFX_GLITCH_ERMA + 18)
#define OBJ_EVENT_GFX_ROUTE_WATER                (OBJ_EVENT_GFX_GLITCH_ERMA + 19)
...
#define OBJ_EVENT_GFX_FOLLOW_MON_6               (OBJ_EVENT_GFX_ROUTE_WATER + 8)
#define OBJ_EVENT_GFX_FOLLOW_MON_7               (OBJ_EVENT_GFX_ROUTE_WATER + 9)
#define OBJ_EVENT_GFX_FOLLOW_MON_8               (OBJ_EVENT_GFX_ROUTE_WATER + 10)
#define OBJ_EVENT_GFX_FOLLOW_MON_9               (OBJ_EVENT_GFX_ROUTE_WATER + 11)
#define OBJ_EVENT_GFX_FOLLOW_MON_A               (OBJ_EVENT_GFX_ROUTE_WATER + 12)
#define OBJ_EVENT_GFX_FOLLOW_MON_B               (OBJ_EVENT_GFX_ROUTE_WATER + 13)
#define OBJ_EVENT_GFX_FOLLOW_MON_C               (OBJ_EVENT_GFX_ROUTE_WATER + 14)
#define OBJ_EVENT_GFX_FOLLOW_MON_D               (OBJ_EVENT_GFX_ROUTE_WATER + 15)
#define OBJ_EVENT_GFX_FOLLOW_MON_E               (OBJ_EVENT_GFX_ROUTE_WATER + 16)
#define OBJ_EVENT_GFX_FOLLOW_MON_F               (OBJ_EVENT_GFX_ROUTE_WATER + 17)
