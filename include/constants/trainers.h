...
#define TRAINER_PIC_PLASMA_GRUNT_M        (TRAINER_PIC_BIKER + 4)
#define TRAINER_PIC_PLASMA_GRUNT_F        (TRAINER_PIC_BIKER + 5)
#define TRAINER_PIC_PLASMA_GHETSIS        (TRAINER_PIC_BIKER + 6)
#define TRAINER_PIC_FLARE_GRUNT_M         (TRAINER_PIC_BIKER + 7)
#define TRAINER_PIC_FLARE_GRUNT_F         (TRAINER_PIC_BIKER + 8)
#define TRAINER_PIC_FLARE_LYSANDRE        (TRAINER_PIC_BIKER + 9)

// Special cases
#define TRAINER_PIC_PLAYER_AVATAR           (TRAINER_PIC_FLARE_LYSANDRE + 1)
#define TRAINER_PIC_PLAYER_OPPOSITE_AVATAR  (TRAINER_PIC_FLARE_LYSANDRE + 2)
