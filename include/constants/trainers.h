...
#define TRAINER_PIC_ETHAN                 (TRAINER_PIC_GALAR_RAIHAN + 1)
#define TRAINER_PIC_LYRA                  (TRAINER_PIC_GALAR_RAIHAN + 2)
#define TRAINER_PIC_LUCAS                 (TRAINER_PIC_GALAR_RAIHAN + 3)
#define TRAINER_PIC_DAWN                  (TRAINER_PIC_GALAR_RAIHAN + 4)
#define TRAINER_PIC_HILBERT               (TRAINER_PIC_GALAR_RAIHAN + 5)
#define TRAINER_PIC_HILDA                 (TRAINER_PIC_GALAR_RAIHAN + 6)
#define TRAINER_PIC_NATE                  (TRAINER_PIC_GALAR_RAIHAN + 7)
#define TRAINER_PIC_ROSA                  (TRAINER_PIC_GALAR_RAIHAN + 8)
#define TRAINER_PIC_CALEM                 (TRAINER_PIC_GALAR_RAIHAN + 9)
#define TRAINER_PIC_SERENA                (TRAINER_PIC_GALAR_RAIHAN + 10)
#define TRAINER_PIC_ELIO                  (TRAINER_PIC_GALAR_RAIHAN + 11)
#define TRAINER_PIC_SELENE                (TRAINER_PIC_GALAR_RAIHAN + 12)
#define TRAINER_PIC_VICTOR                (TRAINER_PIC_GALAR_RAIHAN + 13)
#define TRAINER_PIC_GLORIA                (TRAINER_PIC_GALAR_RAIHAN + 14)

#define TRAINER_PIC_RIVAL_RED             (TRAINER_PIC_GLORIA + 1)
#define TRAINER_PIC_RIVAL_LEAF            (TRAINER_PIC_GLORIA + 2)
#define TRAINER_PIC_RIVAL_ETHAN           (TRAINER_PIC_GLORIA + 3)
#define TRAINER_PIC_RIVAL_LYRA            (TRAINER_PIC_GLORIA + 4)
#define TRAINER_PIC_RIVAL_BRENDAN         (TRAINER_PIC_GLORIA + 5)
#define TRAINER_PIC_RIVAL_MAY             (TRAINER_PIC_GLORIA + 6)
#define TRAINER_PIC_RIVAL_LUCAS           (TRAINER_PIC_GLORIA + 7)
#define TRAINER_PIC_RIVAL_DAWN            (TRAINER_PIC_GLORIA + 8)
#define TRAINER_PIC_RIVAL_HILBERT         (TRAINER_PIC_GLORIA + 9)
#define TRAINER_PIC_RIVAL_HILDA           (TRAINER_PIC_GLORIA + 10)
#define TRAINER_PIC_RIVAL_NATE            (TRAINER_PIC_GLORIA + 11)
#define TRAINER_PIC_RIVAL_ROSA            (TRAINER_PIC_GLORIA + 12)
#define TRAINER_PIC_RIVAL_CALEM           (TRAINER_PIC_GLORIA + 13)
#define TRAINER_PIC_RIVAL_SERENA          (TRAINER_PIC_GLORIA + 14)
#define TRAINER_PIC_RIVAL_ELIO            (TRAINER_PIC_GLORIA + 15)
#define TRAINER_PIC_RIVAL_SELENE          (TRAINER_PIC_GLORIA + 16)
#define TRAINER_PIC_RIVAL_VICTOR          (TRAINER_PIC_GLORIA + 17)
#define TRAINER_PIC_RIVAL_GLORIA          (TRAINER_PIC_GLORIA + 18)

#define TRAINER_PIC_RIVAL_SILVER          (TRAINER_PIC_RIVAL_GLORIA + 1)
#define TRAINER_PIC_RIVAL_BARRY           (TRAINER_PIC_RIVAL_GLORIA + 2)
#define TRAINER_PIC_RIVAL_BIANCA          (TRAINER_PIC_RIVAL_GLORIA + 3)
#define TRAINER_PIC_RIVAL_CHEREN          (TRAINER_PIC_RIVAL_GLORIA + 4)
#define TRAINER_PIC_RIVAL_N               (TRAINER_PIC_RIVAL_GLORIA + 5)
#define TRAINER_PIC_RIVAL_HUGH            (TRAINER_PIC_RIVAL_GLORIA + 6)
#define TRAINER_PIC_RIVAL_SHAUNA          (TRAINER_PIC_RIVAL_GLORIA + 7)
#define TRAINER_PIC_RIVAL_TREVOR          (TRAINER_PIC_RIVAL_GLORIA + 8)
#define TRAINER_PIC_RIVAL_TIERNO          (TRAINER_PIC_RIVAL_GLORIA + 9)
#define TRAINER_PIC_RIVAL_HAU             (TRAINER_PIC_RIVAL_GLORIA + 10)
#define TRAINER_PIC_RIVAL_GLADION         (TRAINER_PIC_RIVAL_GLORIA + 11)
#define TRAINER_PIC_RIVAL_HOP             (TRAINER_PIC_RIVAL_GLORIA + 12)
#define TRAINER_PIC_RIVAL_MARNIE          (TRAINER_PIC_RIVAL_GLORIA + 13)
#define TRAINER_PIC_RIVAL_BEDE            (TRAINER_PIC_RIVAL_GLORIA + 14)

#define TRAINER_PIC_POKABBIE              (TRAINER_PIC_RIVAL_BEDE + 1)
#define TRAINER_PIC_POKABBIE_JUST_DITTO   (TRAINER_PIC_RIVAL_BEDE + 2) // Just used for battle transition
#define TRAINER_PIC_POKABBIE_AND_DITTO    (TRAINER_PIC_RIVAL_BEDE + 3)
#define TRAINER_PIC_GLITCH_KATE           (TRAINER_PIC_RIVAL_BEDE + 4)
#define TRAINER_PIC_GLITCH_TAILS          (TRAINER_PIC_RIVAL_BEDE + 5)
#define TRAINER_PIC_GLITCH_ERMA           (TRAINER_PIC_RIVAL_BEDE + 6)
#define TRAINER_PIC_GLITCH_RANDOMAN       (TRAINER_PIC_RIVAL_BEDE + 7)
