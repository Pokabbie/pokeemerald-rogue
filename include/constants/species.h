...
// Rogueian Forms
#define SPECIES_WOBBUFFET_ROGUEIAN            FORMS_START + 330

// Rogueian alternate forms
#define SPECIES_WOBBUFFET_ROGUEIAN_PUNCHING   FORMS_START + 331

#define FORMS_START SPECIES_ENAMORUS
#define SPECIES_EGG SPECIES_WOBBUFFET_ROGUEIAN_PUNCHING + 1
