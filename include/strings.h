...
extern const u8 gText_Birch_AvatarStyle[];
...
extern const u8 gText_BirchEmrBrendan[];
extern const u8 gText_BirchEmrMay[];
extern const u8 gText_BirchRSBrendan[];
extern const u8 gText_BirchRSMay[];
