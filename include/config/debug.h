...
#else
#define ROGUE_DEBUG_ACTIVE FALSE
#endif

// Overworld Debug
#define DEBUG_OVERWORLD_MENU            ROGUE_DEBUG_ACTIVE                // Enables an overworld debug menu to change flags, variables, giving pokemon and more, accessed by holding R and pressing START while in the overworld by default.
...
// Battle Debug Menu
#define DEBUG_BATTLE_MENU               ROGUE_DEBUG_ACTIVE    // If set to TRUE, enables a debug menu to use in battles by pressing the Select button.
...
// Pokémon Debug
#define DEBUG_POKEMON_MENU              ROGUE_DEBUG_ACTIVE    // Enables a debug menu for pokemon sprites and icons, accessed by pressing SELECT in the summary screen.
