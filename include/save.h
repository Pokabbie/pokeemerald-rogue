...
// 
// Change to new values to give extra space: +464 bytes to SaveBlock1, +116 bytes to SaveBlock2, + 1044 bytes to PokemonStorage
#define SECTOR_DATA_SIZE 4084 // 3968
#define SECTOR_FOOTER_SIZE 12 // 128
