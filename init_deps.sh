...
then
  ...
  unzip tools/poryscript/poryscript-linux.zip -d tools/poryscript/poryscript-linux
  unzip tools/poryscript/poryscript-windows.zip -d tools/poryscript/poryscript-windows
  echo "Done."
fi
