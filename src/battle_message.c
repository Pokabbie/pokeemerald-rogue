...
static const u8 sText_WeatherCleared[] = _("The skies have cleared.");
...
static const u8 sText_PkmnAcquiredOwnTempo[] =_("{B_DEF_NAME_WITH_PREFIX} started following its Own Tempo.");
...
static const u8 sText_ReflectTargetsType[] =_("{B_ATK_NAME_WITH_PREFIX}'s type\nchanged to match {B_DEF_NAME_WITH_PREFIX}'s!{PAUSE_UNTIL_PRESS}");
static const u8 sText_BlendInActivates[] = _("{B_ATK_NAME_WITH_PREFIX}'s {B_ATK_ABILITY} changed its\ntype to match {B_BUFF1}'s!{PAUSE_UNTIL_PRESS}");
static const u8 sText_ProteanLickEffect[] =_("{B_DEF_NAME_WITH_PREFIX}'s type\nchanged to match {B_ATK_NAME_WITH_PREFIX}'s!{PAUSE_UNTIL_PRESS}");
...
static const u8 sText_SharedBerry[] = _("{B_ATK_NAME_WITH_PREFIX} gave its {B_LAST_ITEM}\nto {B_ATK_PARTNER_NAME}!");
...
static const u8 sText_MachFiveSpeed[] = _("{B_ATK_NAME_WITH_PREFIX} reached {B_BUFF1} km/h!");
static const u8 sText_ScavengeItemFound[] = _("{B_ATK_NAME_WITH_PREFIX} scavenged {B_BUFF1}!{PAUSE_UNTIL_PRESS}");
static const u8 sText_ElementalActivates[] = _("{B_ATK_NAME_WITH_PREFIX}'s Elemental\nalters its Normal moves!{PAUSE_UNTIL_PRESS}");
static const u8 sText_PkmnHideBehindAlly[] = _("{B_ATK_NAME_WITH_PREFIX} hid behind\n{B_ATK_PARTNER_NAME}!");
static const u8 sText_PkmnDeepBreath[] = _("{B_ATK_NAME_WITH_PREFIX} took a deep breath!");
...
const u8 *const gBattleStringsTable[BATTLESTRINGS_COUNT] =
{
    ...
    [STRINGID_PKMNACQUIREDOWNTEMPO - BATTLESTRINGS_TABLE_START] = sText_PkmnAcquiredOwnTempo,
    ...
    [STRINGID_PROTEANLICKEFFECT - BATTLESTRINGS_TABLE_START] = sText_ProteanLickEffect,
    ...
    [STRINGID_D2D_WEATHERCLEARED - BATTLESTRINGS_TABLE_START] = sText_WeatherCleared,
    [STRINGID_D2D_SHAREDBERRY - BATTLESTRINGS_TABLE_START] = sText_SharedBerry,
    [STRINGID_D2D_STATUSIMBUED - BATTLESTRINGS_TABLE_START] = sText_StatusImbued,
    [STRINGID_D2D_BLENDINACTIVATES - BATTLESTRINGS_TABLE_START] = sText_BlendInActivates,
    [STRINGID_D2D_MACH5SPEED - BATTLESTRINGS_TABLE_START] = sText_MachFiveSpeed,
    [STRINGID_D2D_SCAVENGEITEMFOUND - BATTLESTRINGS_TABLE_START] = sText_ScavengeItemFound,
    [STRINGID_D2D_ELEMENTALACTIVATES - BATTLESTRINGS_TABLE_START] = sText_ElementalActivates,
    [STRINGID_D2D_PKMNHIDEBEHINDALLY - BATTLESTRINGS_TABLE_START] = sText_PkmnHideBehindAlly,
    [STRINGID_D2D_PKMNDEEPBREATH - BATTLESTRINGS_TABLE_START] = sText_PkmnDeepBreath,
};
