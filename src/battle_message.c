...
const u8 gText_SafariZoneMenuNoBallSwap[] = _("CATCH{CLEAR_TO 56}{FONT_SMALL_NARROW}{COLOR DYNAMIC_COLOR6}{SHADOW DYNAMIC_COLOR5}SWAPBALL\n{CLEAR_TO 56}{FONT_NORMAL}{COLOR DYNAMIC_COLOR4}{SHADOW DYNAMIC_COLOR6}RUN");
