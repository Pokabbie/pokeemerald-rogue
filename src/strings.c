...
const u8 gText_ShopCraft[] = _("Craft");
...
const u8 gText_CraftVar1AndYouWantedVar2[] = _("{STR_VAR_1}? And you wanted {STR_VAR_2}?\nThat will take {STR_VAR_3} to craft.");
...
const u8 gText_QuickHealMove[] = _("{COLOR GREEN}Quick Heal");
...
const u8 gText_PkmnHealed[] = _("{STR_VAR_1} was healed.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_OptionSpeed[] = _("Speed");
