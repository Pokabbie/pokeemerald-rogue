...
const u8 gText_DadsAdvice[] = _("SCOTT's voice echos…\n{PLAYER}, not now… not here…{PAUSE_UNTIL_PRESS}");
...
const u8 gText_PokedexLevelMove[] = _("{COLOR RED}{SHADOW LIGHT_RED}{LV}{STR_VAR_1} {COLOR DARK_GRAY}{SHADOW LIGHT_GRAY}{STR_VAR_2}");
const u8 gText_PokedexEvoMove[] = _("{COLOR LIGHT_GRAY}{SHADOW RED}Evo. {COLOR DARK_GRAY}{SHADOW LIGHT_GRAY}{STR_VAR_1}");
const u8 gText_PokedexTMMove[] = _("{COLOR LIGHT_GREEN}{SHADOW LIGHT_GRAY}TM.  {COLOR DARK_GRAY}{SHADOW LIGHT_GRAY}{STR_VAR_1}");
const u8 gText_PokedexEggMove[] = _("{COLOR BLUE}{SHADOW LIGHT_BLUE}Egg  {COLOR DARK_GRAY}{SHADOW LIGHT_GRAY}{STR_VAR_1}");
const u8 gText_PokedexTutorMove[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}Tutor {COLOR DARK_GRAY}{SHADOW LIGHT_GRAY}{STR_VAR_1}");
...
const u8 gText_ExpandSouth[] = _("{DOWN_ARROW} SOUTH");
const u8 gText_ExpandNorth[] = _("{UP_ARROW} NORTH");
const u8 gText_ExpandEast[] = _("{RIGHT_ARROW} EAST");
...
const u8 gText_OptionControls[] = _("CONTROLS");
const u8 gText_OptionUI[] = _("UI");
const u8 gText_OptionAudio[] = _("AUDIO");
const u8 gText_TextSpeed[] = _("TEXT SPEED");
const u8 gText_BattleSceneDefault[] = _("NORM BATTLE ANIM");
const u8 gText_BattleSceneBoss[] = _("KEY BATTLE ANIM");
...
const u8 gText_TextSpeedMid[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}FAST");
const u8 gText_TextSpeedFast[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}INSTANT");
...
const u8 gText_TimeOfDayVisible[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}VISIBLE");
const u8 gText_TimeOfDayHidden[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}HIDDEN");
...
const u8 gText_MenuQuickSave[] = _("SUSPEND");
const u8 gText_MenuRetireRun[] = _("ABANDON");
...
const u8 gText_MoveRelearnerPkmnForgotMoveAndLearnedNew[] = _("{STR_VAR_1} forgot {STR_VAR_3}.\p{STR_VAR_1} learned {STR_VAR_2}.");
