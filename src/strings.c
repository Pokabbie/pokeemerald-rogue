...
const u8 gText_StonesPocket[] = _("{FONT_NARROW}SP.HELD ITEMS");
...
const u8 gText_ShopUpgrade[] = _("BUILD UPGRADES");
const u8 gText_ShopAreas[] = _("BUILD AREAS");
