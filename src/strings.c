...
const u8 gText_BirchEmrBrendan[] = _("EM BRENDAN");
const u8 gText_BirchEmrMay[] = _("EM MAY");
const u8 gText_BirchRSBrendan[] = _("RS BRENDAN");
const u8 gText_BirchRSMay[] = _("RS MAY");
