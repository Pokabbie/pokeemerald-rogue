...
const u8 gText_LeagueChamp[] = _("LEAGUE CHAMPION{STR_VAR_1}\nCONGRATULATIONS{STR_VAR_2}");
...
const u8 gText_ContinueMenuBadges[] = _("QUESTS");
...
const u8 gText_RogueRoomProgress[] = _("ROUTE: {STR_VAR_1}\nBADGES: {STR_VAR_2}\nTIME: {STR_VAR_3}");
const u8 gText_RogueCampaignProgress[] = _("SCORE: {STR_VAR_1}\nBADGES: {STR_VAR_2}\nTIME: {STR_VAR_3}");
const u8 gText_RogueHourMinute[] = _("{STR_VAR_1}:{STR_VAR_2}");
