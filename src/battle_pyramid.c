...
static const struct PyramidTrainerEncounterMusic sTrainerClassEncounterMusic[] =
{
    ...
    {TRAINER_CLASS_KANTO_CHAMPION, TRAINER_ENCOUNTER_MUSIC_MALE},
    {TRAINER_CLASS_COMMUNITY_CHALLENGER, TRAINER_ENCOUNTER_MUSIC_MALE},
    {TRAINER_CLASS_PAST_ATTEMPT, TRAINER_ENCOUNTER_MUSIC_MALE},
