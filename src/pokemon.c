...
static const u16 sSpeciesToNationalPokedexNum[NUM_SPECIES - 1] =
{
    ...
    [SPECIES_MAREEP_PIKIN - 1] = NATIONAL_DEX_MAREEP,
    [SPECIES_MAREEP_PIKIN_MEGA - 1] = NATIONAL_DEX_MAREEP,
...
#endif
{
    ...
    [SPECIES_MAREEP_PIKIN - 1]        = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_MAREEP_PIKIN_MEGA - 1]      = ANIM_FLASH_YELLOW,
...
static const u8 sMonAnimationDelayTable[NUM_SPECIES - 1] =
{
    ...
    [SPECIES_MAREEP_PIKIN - 1]     = 50,
    [SPECIES_MAREEP_PIKIN_MEGA - 1]   = 10,
...
void SetNature(struct Pokemon *mon, u8 nature)
{
    ...
    for(i = 0; i < 100000; ++i)
    {
        ...
        if(gender == GetMonGender(mon) && isMonShiny == IsMonShiny(mon))
            break;
