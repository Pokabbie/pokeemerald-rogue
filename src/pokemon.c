...
static const u16 sSpeciesToNationalPokedexNum[NUM_SPECIES - 1] =
{
    ...
    // Rogueian forms
    [SPECIES_WOBBUFFET_ROGUEIAN - 1] = NATIONAL_DEX_WOBBUFFET,

    [SPECIES_WOBBUFFET_ROGUEIAN_PUNCHING - 1] = NATIONAL_DEX_WOBBUFFET,
};
...
#endif
{
    ...
    // Rogueian Forms
    [SPECIES_WOBBUFFET_ROGUEIAN - 1]     = ANIM_DEEP_V_SQUISH_AND_BOUNCE,

    [SPECIES_WOBBUFFET_ROGUEIAN_PUNCHING - 1]     = ANIM_DEEP_V_SQUISH_AND_BOUNCE,
};
...
u16 MonTryLearningNewMove(struct Pokemon *mon, bool8 firstMove)
{
    ...
    if (firstMove)
    {
        ...
        while (gRoguePokemonProfiles[species].levelUpMoves[sLearningMoveTableID].level != level)
        {
