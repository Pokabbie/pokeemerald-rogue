...
bool8 ScriptMenu_ShowPokemonPic(u16 species, u8 x, u8 y, bool8 isShiny, u32 otId, u32 personality, bool8 isObscured)
{
    u8 taskId;
    u8 spriteId;
    ...
    {
        spriteId = CreateMonSprite_FieldMove(species, isShiny, otId, personality, x * 8 + 40, y * 8 + 40, 0);
