...
const union AnimCmd *const *const gTrainerFrontAnimsPtrTable[] =
{
    ...
    [TRAINER_PIC_HILBERT] = sAnims_Kanto,
    [TRAINER_PIC_HILDA] = sAnims_Kanto,
    [TRAINER_PIC_NATE] = sAnims_Kanto,
    [TRAINER_PIC_ROSA] = sAnims_Kanto,
    [TRAINER_PIC_CALEM] = sAnims_Kanto,
    [TRAINER_PIC_SERENA] = sAnims_Kanto,
    [TRAINER_PIC_ELIO] = sAnims_Kanto,
    ...
    [TRAINER_PIC_UNOVA_ALDER] = sAnims_Kanto,
    [TRAINER_PIC_UNOVA_BRYCEN] = sAnims_Kanto,
    [TRAINER_PIC_UNOVA_BURGH] = sAnims_Kanto,
    [TRAINER_PIC_UNOVA_CAITLIN] = sAnims_Kanto,
    [TRAINER_PIC_UNOVA_CHILI] = sAnims_Kanto,
    [TRAINER_PIC_UNOVA_CILAN] = sAnims_Kanto,
    [TRAINER_PIC_UNOVA_CLAY] = sAnims_Kanto,
    [TRAINER_PIC_UNOVA_CRESS] = sAnims_Kanto,
    [TRAINER_PIC_UNOVA_DRAYDEN] = sAnims_Kanto,
    [TRAINER_PIC_UNOVA_ELESA] = sAnims_Kanto,
    [TRAINER_PIC_UNOVA_GRIMSLEY] = sAnims_Kanto,
    [TRAINER_PIC_UNOVA_IRIS] = sAnims_Kanto,
    [TRAINER_PIC_UNOVA_LENORA] = sAnims_Kanto,
    [TRAINER_PIC_UNOVA_MARLON] = sAnims_Kanto,
    [TRAINER_PIC_UNOVA_MARSHAL] = sAnims_Kanto,
    [TRAINER_PIC_UNOVA_ROXIE] = sAnims_Kanto,
    [TRAINER_PIC_UNOVA_SHAUNTAL] = sAnims_Kanto,
    [TRAINER_PIC_UNOVA_SKYLA] = sAnims_Kanto,

    [TRAINER_PIC_KALOS_CLEMONT] = sAnims_Kanto,
    [TRAINER_PIC_KALOS_DIANTHA] = sAnims_Kanto,
    [TRAINER_PIC_KALOS_DRASNA] = sAnims_Kanto,
    [TRAINER_PIC_KALOS_GRANT] = sAnims_Kanto,
    [TRAINER_PIC_KALOS_KORRINA] = sAnims_Kanto,
    [TRAINER_PIC_KALOS_MALVA] = sAnims_Kanto,
    [TRAINER_PIC_KALOS_OLYMPIA] = sAnims_Kanto,
    [TRAINER_PIC_KALOS_RAMOS] = sAnims_Kanto,
    [TRAINER_PIC_KALOS_SIEBOLD] = sAnims_Kanto,
    [TRAINER_PIC_KALOS_VALERIE] = sAnims_Kanto,
    [TRAINER_PIC_KALOS_VIOLA] = sAnims_Kanto,
    [TRAINER_PIC_KALOS_WIKSTROM] = sAnims_Kanto,
    [TRAINER_PIC_KALOS_WULFRIC] = sAnims_Kanto,

    [TRAINER_PIC_ALOLA_ACEROLA] = sAnims_Kanto,
    [TRAINER_PIC_ALOLA_HALA] = sAnims_Kanto,
    [TRAINER_PIC_ALOLA_HAPU] = sAnims_Kanto,
    [TRAINER_PIC_ALOLA_ILIMA] = sAnims_Kanto,
    [TRAINER_PIC_ALOLA_KAHILI] = sAnims_Kanto,
    [TRAINER_PIC_ALOLA_KIAWE] = sAnims_Kanto,
    [TRAINER_PIC_ALOLA_KUKUI] = sAnims_Kanto,
    [TRAINER_PIC_ALOLA_LANA] = sAnims_Kanto,
    [TRAINER_PIC_ALOLA_MALLOW] = sAnims_Kanto,
    [TRAINER_PIC_ALOLA_MINA] = sAnims_Kanto,
    [TRAINER_PIC_ALOLA_MOLAYNE] = sAnims_Kanto,
    ...
    [TRAINER_PIC_GLITCH_RANDOMAN] = sAnims_Kanto,
    ...
    [TRAINER_PIC_RIVAL_ETHAN] = sAnims_Kanto,
    [TRAINER_PIC_RIVAL_LYRA] = sAnims_Kanto,
    [TRAINER_PIC_RIVAL_BRENDAN] = sAnims_Kanto,
    [TRAINER_PIC_RIVAL_MAY] = sAnims_Kanto,
    [TRAINER_PIC_RIVAL_LUCAS] = sAnims_Kanto,
    [TRAINER_PIC_RIVAL_DAWN] = sAnims_Kanto,
    [TRAINER_PIC_RIVAL_HILBERT] = sAnims_Kanto,
    [TRAINER_PIC_RIVAL_HILDA] = sAnims_Kanto,
    [TRAINER_PIC_RIVAL_NATE] = sAnims_Kanto,
    [TRAINER_PIC_RIVAL_ROSA] = sAnims_Kanto,
    [TRAINER_PIC_RIVAL_CALEM] = sAnims_Kanto,
    [TRAINER_PIC_RIVAL_SERENA] = sAnims_Kanto,
    [TRAINER_PIC_RIVAL_ELIO] = sAnims_Kanto,
