...
static const struct RogueRouteEncounter sRogueRouteTable[] = {
    ...
    },
    {
        ...
        .wildTypeTable = { TYPE_WATER, TYPE_FLYING, TYPE_GHOST }
    },
...
static const struct RogueEncounterMap sRouteMapsSpecial[] = 
{
...
#ifdef ROGUE_EXPANSION
    ENCOUNTER_MAP(SPECIES_UXIE, ROGUE_SPECIAL_GEN4_MON),
    ENCOUNTER_MAP(SPECIES_MESPRIT, ROGUE_SPECIAL_GEN4_MON),
    ENCOUNTER_MAP(SPECIES_AZELF, ROGUE_SPECIAL_GEN4_MON),
    ENCOUNTER_MAP(SPECIES_DIALGA, ROGUE_SPECIAL_GEN4_MON),
    ENCOUNTER_MAP(SPECIES_PALKIA, ROGUE_SPECIAL_GEN4_MON),
    ENCOUNTER_MAP(SPECIES_HEATRAN, ROGUE_SPECIAL_GEN4_MON),
    ENCOUNTER_MAP(SPECIES_REGIGIGAS, ROGUE_SPECIAL_GEN4_MON),
    ENCOUNTER_MAP(SPECIES_GIRATINA, ROGUE_SPECIAL_GEN4_MON),
    ENCOUNTER_MAP(SPECIES_CRESSELIA, ROGUE_SPECIAL_GEN4_MON),
    ENCOUNTER_MAP(SPECIES_PHIONE, ROGUE_SPECIAL_GEN4_MON),
    ENCOUNTER_MAP(SPECIES_MANAPHY, ROGUE_SPECIAL_GEN4_MON),
    ENCOUNTER_MAP(SPECIES_DARKRAI, ROGUE_SPECIAL_GEN4_MON),
    ENCOUNTER_MAP(SPECIES_SHAYMIN, ROGUE_SPECIAL_GEN4_MON),
    ENCOUNTER_MAP(SPECIES_ARCEUS, ROGUE_SPECIAL_GEN4_MON),
    ...
    ENCOUNTER_MAP(SPECIES_REGIELEKI, ROGUE_SPECIAL_GEN8_MON),
    ENCOUNTER_MAP(SPECIES_REGIDRAGO, ROGUE_SPECIAL_GEN8_MON),
