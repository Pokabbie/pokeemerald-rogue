...
static const struct RogueEncounterMap sRogueTeamEncounters[] = 
{
    ...
    ENCOUNTER_MAP(TEAM_NUM_AQUA + TEAM_PRE_LEGEND_MAP_OFFSET, ROGUE_ENCOUNTER_SILPH_CO),

    ENCOUNTER_MAP(TEAM_NUM_MAGMA, ROGUE_ENCOUNTER_ROCKET_HIDEOUT),
    ENCOUNTER_MAP(TEAM_NUM_MAGMA + TEAM_PRE_LEGEND_MAP_OFFSET, ROGUE_ENCOUNTER_SILPH_CO),
};
