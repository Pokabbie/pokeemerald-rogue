...
static const struct RogueEncounterMap sRogueTeamEncounters[] = 
{
    ...
    ENCOUNTER_MAP(TEAM_NUM_PLASMA, ROGUE_ENCOUNTER_CHARGE_STONE_CAVE),
    ENCOUNTER_MAP(TEAM_NUM_PLASMA + TEAM_PRE_LEGEND_MAP_OFFSET, ROGUE_ENCOUNTER_DRAGON_SPIRAL_TOWER),

    ENCOUNTER_MAP(TEAM_NUM_NEOPLASMA, ROGUE_ENCOUNTER_ROCKET_HIDEOUT),
    ENCOUNTER_MAP(TEAM_NUM_NEOPLASMA + TEAM_PRE_LEGEND_MAP_OFFSET, ROGUE_ENCOUNTER_SILPH_CO),

    ENCOUNTER_MAP(TEAM_NUM_FLARE, ROGUE_ENCOUNTER_ROCKET_HIDEOUT),
    ENCOUNTER_MAP(TEAM_NUM_FLARE + TEAM_PRE_LEGEND_MAP_OFFSET, ROGUE_ENCOUNTER_SILPH_CO),
};
