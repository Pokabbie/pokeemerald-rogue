...
static const struct RogueEncounterMap sRogueLegendaryEncounters[] = 
{
    ...
    // TODO
    ENCOUNTER_MAP(SPECIES_ENAMORUS, ROGUE_SPECIAL_GEN8_MON),

    ENCOUNTER_MAP(SPECIES_WO_CHIEN, ROGUE_SPECIAL_GEN8_MON),
    ENCOUNTER_MAP(SPECIES_CHIEN_PAO, ROGUE_SPECIAL_GEN8_MON),
    ENCOUNTER_MAP(SPECIES_TING_LU, ROGUE_SPECIAL_GEN8_MON),
    ENCOUNTER_MAP(SPECIES_CHI_YU, ROGUE_SPECIAL_GEN8_MON),

    ENCOUNTER_MAP(SPECIES_KORAIDON, ROGUE_SPECIAL_GEN8_MON),
    ENCOUNTER_MAP(SPECIES_MIRAIDON, ROGUE_SPECIAL_GEN8_MON),

    ENCOUNTER_MAP(SPECIES_WALKING_WAKE, ROGUE_SPECIAL_GEN8_MON),
    ENCOUNTER_MAP(SPECIES_IRON_LEAVES, ROGUE_SPECIAL_GEN8_MON),
    ENCOUNTER_MAP(SPECIES_GOUGING_FIRE, ROGUE_SPECIAL_GEN8_MON),
    ENCOUNTER_MAP(SPECIES_RAGING_BOLT, ROGUE_SPECIAL_GEN8_MON),
    ENCOUNTER_MAP(SPECIES_IRON_BOULDER, ROGUE_SPECIAL_GEN8_MON),
    ENCOUNTER_MAP(SPECIES_IRON_CROWN, ROGUE_SPECIAL_GEN8_MON),

    ENCOUNTER_MAP(SPECIES_TERAPAGOS, ROGUE_SPECIAL_GEN8_MON),
    ENCOUNTER_MAP(SPECIES_PECHARUNT, ROGUE_SPECIAL_GEN8_MON),

    ENCOUNTER_MAP(SPECIES_OKIDOGI, ROGUE_SPECIAL_GEN8_MON),
    ENCOUNTER_MAP(SPECIES_MUNKIDORI, ROGUE_SPECIAL_GEN8_MON),
    ENCOUNTER_MAP(SPECIES_FEZANDIPITI, ROGUE_SPECIAL_GEN8_MON),
    ENCOUNTER_MAP(SPECIES_OGERPON, ROGUE_SPECIAL_GEN8_MON),
...
static const struct RogueEncounterMap sRogueTeamEncounters[] = 
{
    ...
    ENCOUNTER_MAP(TEAM_NUM_KANTO_ROCKET + TEAM_PRE_LEGEND_MAP_OFFSET, ROGUE_ENCOUNTER_ROCKET_HIDEOUT),

    ENCOUNTER_MAP(TEAM_NUM_JOHTO_ROCKET, ROGUE_ENCOUNTER_ROCKET_HIDEOUT),
    ENCOUNTER_MAP(TEAM_NUM_JOHTO_ROCKET + TEAM_PRE_LEGEND_MAP_OFFSET, ROGUE_ENCOUNTER_ROCKET_HIDEOUT),

    ENCOUNTER_MAP(TEAM_NUM_AQUA, ROGUE_ENCOUNTER_ROCKET_HIDEOUT),
    ENCOUNTER_MAP(TEAM_NUM_AQUA + TEAM_PRE_LEGEND_MAP_OFFSET, ROGUE_ENCOUNTER_ROCKET_HIDEOUT),

    ENCOUNTER_MAP(TEAM_NUM_MAGMA, ROGUE_ENCOUNTER_ROCKET_HIDEOUT),
    ENCOUNTER_MAP(TEAM_NUM_MAGMA + TEAM_PRE_LEGEND_MAP_OFFSET, ROGUE_ENCOUNTER_ROCKET_HIDEOUT),
};
