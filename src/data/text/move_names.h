...
const u8 gMoveNames[MOVES_COUNT_DYNAMAX][MOVE_NAME_LENGTH + 1] =
{
    ...
    // D2D Moves
    [MOVE_D2D_CLOUDBURST] = _("Cloudburst"),
    ...
    [MOVE_D2D_BITTER_COLD] = _("Bitter Cold"),
    [MOVE_D2D_ICE_BATH] = _("Ice Bath"),
    ...
    [MOVE_D2D_BLOODLETTING] = _("Bloodletting"),
    [MOVE_D2D_DEVOUR] = _("Devour"),
    [MOVE_D2D_IMPLOSION] = _("Implosion"),
    [MOVE_D2D_CAMO_CLAW] = _("Camo Claw"),
    [MOVE_D2D_PROTEAN_LICK] = _("Protean Lick"),
    [MOVE_D2D_SYNESTHESIA] = _("Synesthesia"),
    [MOVE_D2D_LEFT_HOOK] = _("Left Hook"),
    [MOVE_D2D_RIGHT_HOOK] = _("Right Hook"),
    [MOVE_D2D_ENFLAME] = _("Enfire"),
    ...
    [MOVE_D2D_SCAVENGE] = _("Scavenge"),
    [MOVE_D2D_MONEY_SHOT] = _("Money Shot"),
    [MOVE_D2D_URGENT_CARE] = _("Full Restore"),
    [MOVE_D2D_HIDE] = _("Hide"),
    [MOVE_D2D_SEW_SHUT] = _("Sew Shut"),
    [MOVE_D2D_BELLOW] = _("Bellow"),
    // Max Moves
