const u8 gTrainerClassNames[][13] = {
    ...
    [TRAINER_CLASS_TEAM_PLASMA] = _("PLASMA"),
    [TRAINER_CLASS_TEAM_PLASMA_LEADER] = _("PLASMA"),
    [TRAINER_CLASS_TEAM_NEOPLASMA] = _("NEO-PLASMA"),
    [TRAINER_CLASS_TEAM_NEOPLASMA_LEADER] = _("NEO-PLASMA"),
    [TRAINER_CLASS_TEAM_FLARE] = _("FLARE"),
    [TRAINER_CLASS_TEAM_FLARE_LEADER] = _("FLARE"),
