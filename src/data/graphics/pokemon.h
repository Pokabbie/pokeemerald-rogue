...
const u32 gMonFrontPic_MareepPikin[] = INCBIN_U32("graphics/pokemon/mareep/pikin/front.4bpp.lz");
...
const u32 gMonBackPic_MareepPikin[] = INCBIN_U32("graphics/pokemon/mareep/pikin/back.4bpp.lz");
...
const u8 gMonIcon_MareepPikin[] = INCBIN_U8("graphics/pokemon/mareep/pikin/icon.4bpp");
