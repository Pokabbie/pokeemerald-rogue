...
static const struct FormChange sCastformFormChangeTable[] = {
    ...
    {FORM_CHANGE_BATTLE_WEATHER,                SPECIES_CASTFORM_NORMAL, ~(B_WEATHER_SUN | B_WEATHER_RAIN | B_WEATHER_HAIL | B_WEATHER_SNOW | B_WEATHER_SANDSTORM), ABILITY_FORECAST},
    ...
    {FORM_CHANGE_BATTLE_WEATHER,                SPECIES_CASTFORM_NORMAL, ~(B_WEATHER_SUN | B_WEATHER_RAIN | B_WEATHER_HAIL | B_WEATHER_SNOW | B_WEATHER_SANDSTORM)},
...
static const struct FormChange sCloudformFormChangeTable[] = {
#if B_WEATHER_FORMS >= GEN_5
    {FORM_CHANGE_BATTLE_WEATHER,                SPECIES_CLOUDFORM_SUNNY, B_WEATHER_SUN, ABILITY_FORECAST},
    {FORM_CHANGE_BATTLE_WEATHER,                SPECIES_CLOUDFORM_RAINY, B_WEATHER_RAIN, ABILITY_FORECAST},
    {FORM_CHANGE_BATTLE_WEATHER,                SPECIES_CLOUDFORM_SNOWY, B_WEATHER_HAIL | B_WEATHER_SNOW, ABILITY_FORECAST},
    {FORM_CHANGE_BATTLE_WEATHER,                SPECIES_CLOUDFORM_SANDY, B_WEATHER_SANDSTORM, ABILITY_FORECAST},
    {FORM_CHANGE_BATTLE_WEATHER,                SPECIES_CLOUDFORM_NORMAL, ~(B_WEATHER_SUN | B_WEATHER_RAIN | B_WEATHER_HAIL | B_WEATHER_SNOW | B_WEATHER_SANDSTORM), ABILITY_FORECAST},
    {FORM_CHANGE_BATTLE_WEATHER,                SPECIES_CLOUDFORM_NORMAL, B_WEATHER_NONE, ABILITY_FORECAST},
#else
    {FORM_CHANGE_BATTLE_WEATHER,                SPECIES_CLOUDFORM_SUNNY, B_WEATHER_SUN},
    {FORM_CHANGE_BATTLE_WEATHER,                SPECIES_CLOUDFORM_RAINY, B_WEATHER_RAIN},
    {FORM_CHANGE_BATTLE_WEATHER,                SPECIES_CLOUDFORM_SNOWY, B_WEATHER_HAIL | B_WEATHER_SNOW},
    {FORM_CHANGE_BATTLE_WEATHER,                SPECIES_CLOUDFORM_SANDY, B_WEATHER_SANDSTORM},
    {FORM_CHANGE_BATTLE_WEATHER,                SPECIES_CLOUDFORM_NORMAL, ~(B_WEATHER_SUN | B_WEATHER_RAIN | B_WEATHER_HAIL | B_WEATHER_SNOW | B_WEATHER_SANDSTORM)},
    {FORM_CHANGE_BATTLE_WEATHER,                SPECIES_CLOUDFORM_NORMAL, B_WEATHER_NONE},
#endif
    {FORM_CHANGE_BATTLE_SWITCH,                 SPECIES_CLOUDFORM_NORMAL},
    {FORM_CHANGE_FAINT,                         SPECIES_CLOUDFORM_NORMAL},
    {FORM_CHANGE_END_BATTLE,                    SPECIES_CLOUDFORM_NORMAL},
    {FORM_CHANGE_TERMINATOR},
};
