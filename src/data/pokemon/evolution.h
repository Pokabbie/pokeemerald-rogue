const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_GOLBAT]     = {{EVO_LEVEL, 40, SPECIES_CROBAT}},
    ...
    [SPECIES_CHANSEY]    = {{EVO_LEVEL, 18, SPECIES_BLISSEY}},
    ...
    [SPECIES_PICHU]      = {{EVO_LEVEL, 18, SPECIES_PIKACHU}},
    [SPECIES_CLEFFA]     = {{EVO_LEVEL, 18, SPECIES_CLEFAIRY}},
    [SPECIES_IGGLYBUFF]  = {{EVO_LEVEL, 18, SPECIES_JIGGLYPUFF}},
    [SPECIES_TOGEPI]     = {{EVO_LEVEL, 18, SPECIES_TOGETIC}},
