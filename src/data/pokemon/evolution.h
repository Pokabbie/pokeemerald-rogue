const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_GRAVELER]              = {{EVO_ITEM, ITEM_EVERSTONE, SPECIES_GOLEM}},
    ...
    [SPECIES_HAUNTER]               = {{EVO_ITEM, ITEM_EVERSTONE, SPECIES_GENGAR}},
    ...
    [SPECIES_SCYTHER]               = {{EVO_ITEM, ITEM_METAL_COAT, SPECIES_SCIZOR}, {EVO_ITEM, ITEM_EVERSTONE, SPECIES_KLEAVOR}},
#if P_GEN_4_POKEMON == TRUE
    ...
    [SPECIES_QUILAVA]               = {{EVO_LEVEL, 36, SPECIES_TYPHLOSION}, {EVO_ITEM, ITEM_EVERSTONE, SPECIES_TYPHLOSION_HISUIAN}},
    ...
    [SPECIES_MAREEP_PIKIN]          = {{EVO_MOVE_MEGA_EVOLUTION, MOVE_METEOR_BEAM, SPECIES_MAREEP_PIKIN_MEGA}},
    ...
    [SPECIES_DEWOTT]                = {{EVO_LEVEL, 36, SPECIES_SAMUROTT}, {EVO_ITEM, ITEM_EVERSTONE, SPECIES_SAMUROTT_HISUIAN}},
    ...
    [SPECIES_BOLDORE]               = {{EVO_ITEM, ITEM_EVERSTONE, SPECIES_GIGALITH}},
    ...
    [SPECIES_GURDURR]               = {{EVO_ITEM, ITEM_EVERSTONE, SPECIES_CONKELDURR}},
    ...
    [SPECIES_PETILIL]               = {{EVO_ITEM, ITEM_SUN_STONE, SPECIES_LILLIGANT}, {EVO_ITEM, ITEM_EVERSTONE, SPECIES_LILLIGANT_HISUIAN}},
    ...
    [SPECIES_KARRABLAST]            = {{EVO_ITEM, ITEM_EVERSTONE, SPECIES_ESCAVALIER}},
    ...
    [SPECIES_SHELMET]               = {{EVO_ITEM, ITEM_EVERSTONE, SPECIES_ACCELGOR}},
    ...
    [SPECIES_RUFFLET]               = {{EVO_LEVEL, 54, SPECIES_BRAVIARY}, {EVO_ITEM, ITEM_EVERSTONE, SPECIES_BRAVIARY_HISUIAN}},
    ...
    [SPECIES_SPRITZEE]              = {{EVO_ITEM, ITEM_SACHET, SPECIES_AROMATISSE}},
    [SPECIES_SWIRLIX]               = {{EVO_ITEM, ITEM_WHIPPED_DREAM, SPECIES_SLURPUFF}},
    ...
    [SPECIES_GOOMY]                 = {{EVO_LEVEL, 40, SPECIES_SLIGGOO}, {EVO_ITEM, ITEM_EVERSTONE, SPECIES_SLIGGOO_HISUIAN}},
    [SPECIES_SLIGGOO]               = {{EVO_LEVEL_RAIN, 50, SPECIES_GOODRA}},
    [SPECIES_PHANTUMP]              = {{EVO_ITEM, ITEM_EVERSTONE, SPECIES_TREVENANT}},
    [SPECIES_PUMPKABOO]             = {{EVO_ITEM, ITEM_EVERSTONE, SPECIES_GOURGEIST}},
    [SPECIES_BERGMITE]              = {{EVO_LEVEL, 37, SPECIES_AVALUGG}, {EVO_ITEM, ITEM_EVERSTONE, SPECIES_AVALUGG_HISUIAN}},
    ...
    [SPECIES_DARTRIX]               = {{EVO_LEVEL, 34, SPECIES_DECIDUEYE}, {EVO_ITEM, ITEM_EVERSTONE, SPECIES_DECIDUEYE_HISUIAN}},
    ...
    [SPECIES_GRAVELER_ALOLAN]       = {{EVO_ITEM, ITEM_EVERSTONE, SPECIES_GOLEM_ALOLAN}},
    ...
    [SPECIES_PUMPKABOO_SMALL]       = {{EVO_ITEM, ITEM_EVERSTONE, SPECIES_GOURGEIST_SMALL}},
    [SPECIES_PUMPKABOO_LARGE]       = {{EVO_ITEM, ITEM_EVERSTONE, SPECIES_GOURGEIST_LARGE}},
    [SPECIES_PUMPKABOO_SUPER]       = {{EVO_ITEM, ITEM_EVERSTONE, SPECIES_GOURGEIST_SUPER}},
#endif
#if P_GEN_7_POKEMON == TRUE
    ...
    [SPECIES_STANTLER]      = {{EVO_ITEM, ITEM_EVERSTONE, SPECIES_WYRDEER}},
    [SPECIES_URSARING]      = {{EVO_ITEM, ITEM_EVERSTONE, SPECIES_URSALUNA}},
    [SPECIES_BASCULIN_WHITE_STRIPED]      = {{EVO_ITEM, ITEM_EVERSTONE, SPECIES_BASCULEGION}},
    [SPECIES_SNEASEL_HISUIAN]      = {{EVO_ITEM_HOLD_DAY, ITEM_RAZOR_CLAW, SPECIES_SNEASLER}},
    [SPECIES_QWILFISH_HISUIAN]      = {{EVO_ITEM, ITEM_EVERSTONE, SPECIES_OVERQWIL}},
