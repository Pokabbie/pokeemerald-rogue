...
#define TOGEPI_FAMILY_TYPE (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_NORMAL)
    ...
    [SPECIES_XATU] =
    {
        ...
        LEARNSETS(Xatu),
        .formSpeciesIdTable = sXatuFormSpeciesIdTable,
    },
...
#define AMPHAROS_DEFENSE (P_UPDATED_STATS >= GEN_6 ? 85 : 75)
    ...
    [SPECIES_AMPHAROS_ROCKET] =
    {
        ...
        .expYield = 230,
        .abilities = { ABILITY_TRANSISTOR, ABILITY_DRAGONS_MAW, ABILITY_TRANSISTOR },
        .cryId = CRY_AMPHAROS,
        .description = POKEDEX_DESC_STRING(
            "It gives off so much light that it can be\n"
            "seen even from space. People in the old\n"
    ...
    [SPECIES_YANMEGA_ROCKET] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = { EGG_GROUP_BUG, EGG_GROUP_BUG },
        .abilities = { ABILITY_PREDATOR_INSTINCT, ABILITY_NONE, ABILITY_PREDATOR_INSTINCT },
        .bodyColor = BODY_COLOR_GREEN,
        .speciesName = _("TR Yanmega"),
        .cryId = CRY_YANMEGA,
        .natDexNum = NATIONAL_DEX_YANMEGA,
        .categoryName = _("Ogre Darner"),
        .height = 19,
...
#define WOOPER_MISC_INFO                                                        \
    ...
    [SPECIES_HONCHKROW] =
    {
        ...
        LEARNSETS(Honchkrow),
        .formSpeciesIdTable = sHonchkrowFormSpeciesIdTable,
    },

    [SPECIES_HONCHKROW_ROCKET] =
    {
        .baseHP        = 100,
        .baseAttack    = 125,
        .baseDefense   = 60,
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = { EGG_GROUP_FLYING, EGG_GROUP_FLYING },
        .abilities = { ABILITY_SUPREME_OVERLORD, ABILITY_NONE, ABILITY_SUPREME_OVERLORD },
        .bodyColor = BODY_COLOR_BLACK,
        .speciesName = _("TR Honchkr"),
        .cryId = CRY_HONCHKROW,
        .natDexNum = NATIONAL_DEX_HONCHKROW,
        .categoryName = _("Big Boss"),
        .height = 9,
...
#define UNOWN_MISC_INFO(letter)                                         \
    ...
    [SPECIES_FORRETRESS] =
    {
        ...
        .formSpeciesIdTable = sForretressFormSpeciesIdTable,
    },

    [SPECIES_FORRETRESS_ROCKET] =
    {
        .baseHP        = 80,
        .baseAttack    = 100,
        .baseDefense   = 140,
...
#define DUDUNSPARCE_MISC_INFO(segments)                                             \
    ...
    [SPECIES_GLISCOR] =
    {
        ...
        LEARNSETS(Gliscor),
        .formSpeciesIdTable = sGliscorFormSpeciesIdTable,
    },

    [SPECIES_GLISCOR_ROCKET] =
    {
        .baseHP        = 80,
        .baseAttack    = 105,
        .baseDefense   = 125,
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = { EGG_GROUP_BUG, EGG_GROUP_BUG },
        .abilities = { ABILITY_THICK_FAT, ABILITY_POISON_HEAL, ABILITY_THICK_FAT },
        .bodyColor = BODY_COLOR_PURPLE,
        .speciesName = _("TR Gliscor"),
        .cryId = CRY_GLISCOR,
        .natDexNum = NATIONAL_DEX_GLISCOR,
        .categoryName = _("Fang Scorp"),
        .height = 20,
    ...
    [SPECIES_GRANBULL] =
    {
        ...
        LEARNSETS(Granbull),
        .formSpeciesIdTable = sGranbullFormSpeciesIdTable,
    },

    [SPECIES_GRANBULL_ROCKET] =
    {
        .baseHP        = 90,
        .baseAttack    = 130,
        .baseDefense   = 80,
...
#define HOUNDOOM_MISC_INFO                                  \
    ...
    [SPECIES_HOUNDOOM_ROCKET] =
    {
        ...
        .baseSpDefense = 80,
        .expYield = 175,
        .abilities = { ABILITY_BEADS_OF_RUIN, ABILITY_NONE, ABILITY_BEADS_OF_RUIN },
        .cryId = CRY_HOUNDOOM,
        .height = 14,
        .weight = 350,
        .description = POKEDEX_DESC_STRING(
    ...
    [SPECIES_DONPHAN] =
    {
        ...
        LEARNSETS(Donphan),
        .formSpeciesIdTable = sDonphanFormSpeciesIdTable,
    },

    [SPECIES_DONPHAN_ROCKET] =
    {
        .baseHP        = 90,
        .baseAttack    = 125,
        .baseDefense   = 130,
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = { EGG_GROUP_FIELD, EGG_GROUP_FIELD },
        .abilities = { ABILITY_STAMINA, ABILITY_NONE, ABILITY_STAMINA },
        .bodyColor = BODY_COLOR_GRAY,
        .speciesName = _("TR Donphan"),
        .cryId = CRY_DONPHAN,
        .natDexNum = NATIONAL_DEX_DONPHAN,
        .categoryName = _("Armor"),
        .height = 11,
...
[SPECIES_TYRANITAR_ROCKET] =
{
    ...
    .baseSpDefense = 100,
    .expYield = 270,
    .abilities = { ABILITY_FILTER, ABILITY_NONE, ABILITY_FILTER },
    .cryId = CRY_TYRANITAR,
    .height = 20,
    .weight = 2020,
    .description = POKEDEX_DESC_STRING(
