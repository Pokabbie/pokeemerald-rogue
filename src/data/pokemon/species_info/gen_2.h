...
#define AMPHAROS_DEFENSE (P_UPDATED_STATS >= GEN_6 ? 85 : 75)
    ...
    [SPECIES_AMPHAROS] =
    {
        ...
        .types = { TYPE_ELECTRIC, TYPE_ELECTRIC },
        .expYield = 230,
        .abilities = { ABILITY_STATIC, ABILITY_PLUS, ABILITY_LIGHTNING_ROD },
        .cryId = CRY_AMPHAROS,
        .description = POKEDEX_DESC_STRING(
...
#define UNOWN_MISC_INFO(letter)                                         \
        ...
        .growthRate = GROWTH_MEDIUM_FAST,                               \
        .eggGroups = { EGG_GROUP_NO_EGGS_DISCOVERED, EGG_GROUP_NO_EGGS_DISCOVERED },\
        .abilities = { ABILITY_D2D_INFINITY, ABILITY_D2D_INFINITY, ABILITY_D2D_INFINITY }, \
        .bodyColor = BODY_COLOR_BLACK,                                  \
        .speciesName = _("Unown"),                                      \
        .cryId = CRY_UNOWN,                                             \
        ...
        // .evolutions = EVOLUTION({EVO_LEVEL, 42, SPECIES_UNOHM})
    ...
    [SPECIES_FORRETRESS] =
    {
        ...
        .baseSpAttack  = 60,
        .baseSpDefense = 60,
        .types = { TYPE_STEEL, TYPE_BUG }, // TODO: maybe add a ".bomberType" variable and set this back to Bug/Steel
        .catchRate = 75,
        .expYield = 163,
        .evYield_Defense = 2,
        .genderRatio = PERCENT_FEMALE(50),
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = { EGG_GROUP_BUG, EGG_GROUP_BUG },
        .abilities = { ABILITY_STURDY, ABILITY_NONE, ABILITY_D2D_BOMBER },
        .bodyColor = BODY_COLOR_PURPLE,
...
#define CORSOLA_MISC_INFO                                       \
    ...
    [SPECIES_DELIBIRD] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = { EGG_GROUP_WATER_1, EGG_GROUP_FIELD },
        .abilities = { ABILITY_VITAL_SPIRIT, ABILITY_SLUSH_RUSH, ABILITY_SNOW_WARNING },
        .bodyColor = BODY_COLOR_RED,
...
#define HOUNDOOM_MISC_INFO                                  \
    ...
    [SPECIES_HOUNDOOM] =
    {
        ...
        .baseSpDefense = 80,
        .expYield = 175,
        .abilities = { ABILITY_FLASH_FIRE, ABILITY_D2D_BELLOW, ABILITY_UNNERVE },
        .cryId = CRY_HOUNDOOM,
        .height = 14,
        .weight = 350,
        .description = POKEDEX_DESC_STRING(
...
#define TYRANITAR_MISC_INFO                                     \
    ...
    [SPECIES_HO_OH] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = { EGG_GROUP_NO_EGGS_DISCOVERED, EGG_GROUP_NO_EGGS_DISCOVERED },
        .abilities = { ABILITY_PRESSURE, ABILITY_D2D_BELLOW, ABILITY_REGENERATOR },
        .bodyColor = BODY_COLOR_RED,
        .isLegendary = TRUE,
        .speciesName = _("Ho-Oh"),
        .cryId = CRY_HO_OH,
