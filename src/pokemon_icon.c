...
const u8 *const gMonIconTable[NUM_SPECIES + 1] =
{
    ...
    [SPECIES_CLOUDFORM_NORMAL] = gMonIcon_CloudformNormal,
    ...
    [SPECIES_CLOUDFORM_SUNNY] = gMonIcon_CloudformSunny,
    [SPECIES_CLOUDFORM_RAINY] = gMonIcon_CloudformRainy,
    [SPECIES_CLOUDFORM_SNOWY] = gMonIcon_CloudformSnowy,
    [SPECIES_CLOUDFORM_SANDY] = gMonIcon_CloudformSandy,
