...
const u8 *const gMonIconTable[NUM_SPECIES + 1] =
{
    ...
    [SPECIES_TROPISAUR] = gMonIcon_Tropius,
    ...
    [SPECIES_BAYANETTE] = gMonIcon_Bayanette,
    ...
    [SPECIES_HATCHLIN] = gMonIcon_Hatchlin,
    [SPECIES_TEERAX] = gMonIcon_Teerax,
